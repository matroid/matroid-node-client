...
import ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInner from './ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInner';

/**
 * The ApiV1DetectorsDetectorIdClassifyImagePost200Response model module.
 * @module model/ApiV1DetectorsDetectorIdClassifyImagePost200Response
 * @version 1.0.0
 */
class ApiV1DetectorsDetectorIdClassifyImagePost200Response {
    /**
     * Constructs a new <code>ApiV1DetectorsDetectorIdClassifyImagePost200Response</code>.
     * @alias module:model/ApiV1DetectorsDetectorIdClassifyImagePost200Response
     */
    constructor() { 
        
        ApiV1DetectorsDetectorIdClassifyImagePost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1DetectorsDetectorIdClassifyImagePost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1DetectorsDetectorIdClassifyImagePost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1DetectorsDetectorIdClassifyImagePost200Response} The populated <code>ApiV1DetectorsDetectorIdClassifyImagePost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1DetectorsDetectorIdClassifyImagePost200Response();

            if (data.hasOwnProperty('predictions')) {
                obj['predictions'] = ApiClient.convertToType(data['predictions'], [ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1DetectorsDetectorIdClassifyImagePost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1DetectorsDetectorIdClassifyImagePost200Response</code>.
     */
    static validateJSON(data) {
        if (data['predictions']) { // data not null
            ...
            for (const item of data['predictions']) {
                ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInner>} predictions
 */
ApiV1DetectorsDetectorIdClassifyImagePost200Response.prototype['predictions'] = undefined;
...
export default ApiV1DetectorsDetectorIdClassifyImagePost200Response;
