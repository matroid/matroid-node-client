...
import ApiV1BucketTasksPost200ResponseCollectionTask from './ApiV1BucketTasksPost200ResponseCollectionTask';

/**
 * The ApiV1BucketTasksPost200Response model module.
 * @module model/ApiV1BucketTasksPost200Response
 * @version 1.0.0
 */
class ApiV1BucketTasksPost200Response {
    /**
     * Constructs a new <code>ApiV1BucketTasksPost200Response</code>.
     * @alias module:model/ApiV1BucketTasksPost200Response
     */
    constructor() { 
        
        ApiV1BucketTasksPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1BucketTasksPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1BucketTasksPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1BucketTasksPost200Response} The populated <code>ApiV1BucketTasksPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1BucketTasksPost200Response();

            if (data.hasOwnProperty('collectionTask')) {
                obj['collectionTask'] = ApiV1BucketTasksPost200ResponseCollectionTask.constructFromObject(data['collectionTask']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1BucketTasksPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1BucketTasksPost200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `collectionTask`
        if (data['collectionTask']) { // data not null
          ApiV1BucketTasksPost200ResponseCollectionTask.validateJSON(data['collectionTask']);
        }
...
/**
 * @member {module:model/ApiV1BucketTasksPost200ResponseCollectionTask} collectionTask
 */
ApiV1BucketTasksPost200Response.prototype['collectionTask'] = undefined;
...
export default ApiV1BucketTasksPost200Response;
