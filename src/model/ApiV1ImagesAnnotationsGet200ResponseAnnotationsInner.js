...
import ApiV1ImagesAnnotationsGet200ResponseAnnotationsInnerTagsInner from './ApiV1ImagesAnnotationsGet200ResponseAnnotationsInnerTagsInner';

/**
 * The ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner model module.
 * @module model/ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner
 * @version 1.0.0
 */
class ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner {
    /**
     * Constructs a new <code>ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner</code>.
     * @alias module:model/ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner
     */
    constructor() { 
        
        ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner} obj Optional instance to populate.
     * @return {module:model/ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner} The populated <code>ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner();
            ...
            if (data.hasOwnProperty('tags')) {
                obj['tags'] = ApiClient.convertToType(data['tags'], [ApiV1ImagesAnnotationsGet200ResponseAnnotationsInnerTagsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner</code>.
     */
    static validateJSON(data) {
        ...
        if (data['tags']) { // data not null
            ...
            for (const item of data['tags']) {
                ApiV1ImagesAnnotationsGet200ResponseAnnotationsInnerTagsInner.validateJSON(item);
            };
        }
 ...
 */
ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner.prototype['imageId'] = undefined;

/**
 * Name of the label
 * @member {String} labelName
 */
ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner.prototype['labelName'] = undefined;

/**
 * @member {Array.<module:model/ApiV1ImagesAnnotationsGet200ResponseAnnotationsInnerTagsInner>} tags
 */
ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner.prototype['tags'] = undefined;
...
export default ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner;
