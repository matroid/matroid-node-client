...
/**
 * The ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream model module.
 * @module model/ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream
 * @version 1.0.0
 */
class ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream {
    /**
     * Constructs a new <code>ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream</code>.
     * @alias module:model/ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream
     */
    constructor() { 
        
        ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream} obj Optional instance to populate.
     * @return {module:model/ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream} The populated <code>ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream</code>.
     */
 ...
 * @member {String} _id
 */
ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream.prototype['_id'] = undefined;

/**
 * Name of the stream
 * @member {String} name
 */
ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream.prototype['name'] = undefined;
...
export default ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream;
