...
import ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInner from './ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInner';

/**
 * The ApiV1DetectorsDetectorIdFeedbackPost200Response model module.
 * @module model/ApiV1DetectorsDetectorIdFeedbackPost200Response
 * @version 1.0.0
 */
class ApiV1DetectorsDetectorIdFeedbackPost200Response {
    /**
     * Constructs a new <code>ApiV1DetectorsDetectorIdFeedbackPost200Response</code>.
     * @alias module:model/ApiV1DetectorsDetectorIdFeedbackPost200Response
     */
    constructor() { 
        
        ApiV1DetectorsDetectorIdFeedbackPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1DetectorsDetectorIdFeedbackPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1DetectorsDetectorIdFeedbackPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1DetectorsDetectorIdFeedbackPost200Response} The populated <code>ApiV1DetectorsDetectorIdFeedbackPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1DetectorsDetectorIdFeedbackPost200Response();

            if (data.hasOwnProperty('feedback')) {
                obj['feedback'] = ApiClient.convertToType(data['feedback'], [ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1DetectorsDetectorIdFeedbackPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1DetectorsDetectorIdFeedbackPost200Response</code>.
     */
    static validateJSON(data) {
        if (data['feedback']) { // data not null
            ...
            for (const item of data['feedback']) {
                ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInner.validateJSON(item);
            };
        }
...
/**
 * Array of objects with information about the added feedback
 * @member {Array.<module:model/ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInner>} feedback
 */
ApiV1DetectorsDetectorIdFeedbackPost200Response.prototype['feedback'] = undefined;
...
export default ApiV1DetectorsDetectorIdFeedbackPost200Response;
