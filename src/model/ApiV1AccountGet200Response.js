...
import ApiV1AccountGet200ResponseAccount from './ApiV1AccountGet200ResponseAccount';

/**
 * The ApiV1AccountGet200Response model module.
 * @module model/ApiV1AccountGet200Response
 * @version 1.0.0
 */
class ApiV1AccountGet200Response {
    /**
     * Constructs a new <code>ApiV1AccountGet200Response</code>.
     * @alias module:model/ApiV1AccountGet200Response
     */
    constructor() { 
        
        ApiV1AccountGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1AccountGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1AccountGet200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1AccountGet200Response} The populated <code>ApiV1AccountGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1AccountGet200Response();

            if (data.hasOwnProperty('account')) {
                obj['account'] = ApiV1AccountGet200ResponseAccount.constructFromObject(data['account']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1AccountGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1AccountGet200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `account`
        if (data['account']) { // data not null
          ApiV1AccountGet200ResponseAccount.validateJSON(data['account']);
        }
...
/**
 * @member {module:model/ApiV1AccountGet200ResponseAccount} account
 */
ApiV1AccountGet200Response.prototype['account'] = undefined;
...
export default ApiV1AccountGet200Response;
