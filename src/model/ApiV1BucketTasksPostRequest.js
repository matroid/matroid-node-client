...
/**
 * The ApiV1BucketTasksPostRequest model module.
 * @module model/ApiV1BucketTasksPostRequest
 * @version 1.0.0
 */
class ApiV1BucketTasksPostRequest {
    /**
     * Constructs a new <code>ApiV1BucketTasksPostRequest</code>.
     * @alias module:model/ApiV1BucketTasksPostRequest
     * @param detectorId {String} Unique ID of the detector with which to process the bucket
     * @param url {String} URL of the bucket to process (e.g. s3://my-bucket/path/to/files/)
     */
    constructor(detectorId, url) { 
        
        ApiV1BucketTasksPostRequest.initialize(this, detectorId, url);
    }
     ...
     */
    static initialize(obj, detectorId, url) { 
        obj['detectorId'] = detectorId;
        obj['url'] = url;
    }

    /**
     * Constructs a <code>ApiV1BucketTasksPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1BucketTasksPostRequest} obj Optional instance to populate.
     * @return {module:model/ApiV1BucketTasksPostRequest} The populated <code>ApiV1BucketTasksPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1BucketTasksPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1BucketTasksPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1BucketTasksPostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1BucketTasksPostRequest.RequiredProperties) {
...
ApiV1BucketTasksPostRequest.RequiredProperties = ["detectorId", "url"];

/**
 * Unique ID of the detector with which to process the bucket
 * @member {String} detectorId
 */
ApiV1BucketTasksPostRequest.prototype['detectorId'] = undefined;

/**
 * URL of the bucket to process (e.g. s3://my-bucket/path/to/files/)
 * @member {String} url
 */
ApiV1BucketTasksPostRequest.prototype['url'] = undefined;
...
export default ApiV1BucketTasksPostRequest;
