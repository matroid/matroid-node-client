...
/**
 * The ApiV1DetectorsUploadPost200Response model module.
 * @module model/ApiV1DetectorsUploadPost200Response
 * @version 1.0.0
 */
class ApiV1DetectorsUploadPost200Response {
    /**
     * Constructs a new <code>ApiV1DetectorsUploadPost200Response</code>.
     * @alias module:model/ApiV1DetectorsUploadPost200Response
     */
    constructor() { 
        
        ApiV1DetectorsUploadPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1DetectorsUploadPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1DetectorsUploadPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1DetectorsUploadPost200Response} The populated <code>ApiV1DetectorsUploadPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1DetectorsUploadPost200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1DetectorsUploadPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1DetectorsUploadPost200Response</code>.
     */
...
/**
 * Unique ID of the imported detector
 * @member {String} detectorId
 */
ApiV1DetectorsUploadPost200Response.prototype['detectorId'] = undefined;

/**
 * Information about the status of the import
 * @member {String} message
 */
ApiV1DetectorsUploadPost200Response.prototype['message'] = undefined;
...
export default ApiV1DetectorsUploadPost200Response;
