...
import ApiV1SummariesGet200ResponseSummariesInner from './ApiV1SummariesGet200ResponseSummariesInner';

/**
 * The ApiV1SummariesGet200Response model module.
 * @module model/ApiV1SummariesGet200Response
 * @version 1.0.0
 */
class ApiV1SummariesGet200Response {
    /**
     * Constructs a new <code>ApiV1SummariesGet200Response</code>.
     * @alias module:model/ApiV1SummariesGet200Response
     */
    constructor() { 
        
        ApiV1SummariesGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1SummariesGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1SummariesGet200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1SummariesGet200Response} The populated <code>ApiV1SummariesGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1SummariesGet200Response();

            if (data.hasOwnProperty('summaries')) {
                obj['summaries'] = ApiClient.convertToType(data['summaries'], [ApiV1SummariesGet200ResponseSummariesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1SummariesGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1SummariesGet200Response</code>.
     */
    static validateJSON(data) {
        if (data['summaries']) { // data not null
            ...
            for (const item of data['summaries']) {
                ApiV1SummariesGet200ResponseSummariesInner.validateJSON(item);
            };
        }
...
/**
 * All summaries for a user, sorted by most recent
 * @member {Array.<module:model/ApiV1SummariesGet200ResponseSummariesInner>} summaries
 */
ApiV1SummariesGet200Response.prototype['summaries'] = undefined;
...
export default ApiV1SummariesGet200Response;
