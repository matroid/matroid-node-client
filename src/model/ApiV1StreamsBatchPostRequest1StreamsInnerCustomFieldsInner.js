...
/**
 * The ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner model module.
 * @module model/ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner
 * @version 1.0.0
 */
class ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner {
    /**
     * Constructs a new <code>ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner</code>.
     * @alias module:model/ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner
     */
    constructor() { 
        
        ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner} obj Optional instance to populate.
     * @return {module:model/ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner} The populated <code>ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner</code>.
     */
 ...
 * @member {String} key
 */
ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner.prototype['key'] = undefined;

/**
 * Field template
 * @member {String} template
 */
ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner.prototype['template'] = undefined;
...
export default ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner;
