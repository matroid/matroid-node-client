...
/**
 * The ApiV1StreamsStreamIdTemporalTaskPost200Response model module.
 * @module model/ApiV1StreamsStreamIdTemporalTaskPost200Response
 * @version 1.0.0
 */
class ApiV1StreamsStreamIdTemporalTaskPost200Response {
    /**
     * Constructs a new <code>ApiV1StreamsStreamIdTemporalTaskPost200Response</code>.
     * @alias module:model/ApiV1StreamsStreamIdTemporalTaskPost200Response
     */
    constructor() { 
        
        ApiV1StreamsStreamIdTemporalTaskPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1StreamsStreamIdTemporalTaskPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1StreamsStreamIdTemporalTaskPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1StreamsStreamIdTemporalTaskPost200Response} The populated <code>ApiV1StreamsStreamIdTemporalTaskPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1StreamsStreamIdTemporalTaskPost200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1StreamsStreamIdTemporalTaskPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1StreamsStreamIdTemporalTaskPost200Response</code>.
     */
...
/**
 * ID of the created temporal task
 * @member {String} taskId
 */
ApiV1StreamsStreamIdTemporalTaskPost200Response.prototype['taskId'] = undefined;

/**
 * Status of the task
 * @member {String} status
 */
ApiV1StreamsStreamIdTemporalTaskPost200Response.prototype['status'] = undefined;
...
export default ApiV1StreamsStreamIdTemporalTaskPost200Response;
