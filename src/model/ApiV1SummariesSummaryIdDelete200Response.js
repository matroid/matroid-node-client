...
/**
 * The ApiV1SummariesSummaryIdDelete200Response model module.
 * @module model/ApiV1SummariesSummaryIdDelete200Response
 * @version 1.0.0
 */
class ApiV1SummariesSummaryIdDelete200Response {
    /**
     * Constructs a new <code>ApiV1SummariesSummaryIdDelete200Response</code>.
     * @alias module:model/ApiV1SummariesSummaryIdDelete200Response
     */
    constructor() { 
        
        ApiV1SummariesSummaryIdDelete200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1SummariesSummaryIdDelete200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1SummariesSummaryIdDelete200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1SummariesSummaryIdDelete200Response} The populated <code>ApiV1SummariesSummaryIdDelete200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1SummariesSummaryIdDelete200Response();

            if (data.hasOwnProperty('summaryId')) {
                obj['summaryId'] = ApiClient.convertToType(data['summaryId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1SummariesSummaryIdDelete200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1SummariesSummaryIdDelete200Response</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['summaryId'] && !(typeof data['summaryId'] === 'string' || data['summaryId'] instanceof String)) {
            throw new Error("Expected the field `summaryId` to be a primitive type in the JSON string but got " + data['summaryId']);
        }
...
/**
 * Unique ID of deleted video summary
 * @member {String} summaryId
 */
ApiV1SummariesSummaryIdDelete200Response.prototype['summaryId'] = undefined;
...
export default ApiV1SummariesSummaryIdDelete200Response;
