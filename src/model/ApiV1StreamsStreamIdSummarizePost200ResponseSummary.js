...
/**
 * The ApiV1StreamsStreamIdSummarizePost200ResponseSummary model module.
 * @module model/ApiV1StreamsStreamIdSummarizePost200ResponseSummary
 * @version 1.0.0
 */
class ApiV1StreamsStreamIdSummarizePost200ResponseSummary {
    /**
     * Constructs a new <code>ApiV1StreamsStreamIdSummarizePost200ResponseSummary</code>.
     * @alias module:model/ApiV1StreamsStreamIdSummarizePost200ResponseSummary
     */
    constructor() { 
        
        ApiV1StreamsStreamIdSummarizePost200ResponseSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1StreamsStreamIdSummarizePost200ResponseSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1StreamsStreamIdSummarizePost200ResponseSummary} obj Optional instance to populate.
     * @return {module:model/ApiV1StreamsStreamIdSummarizePost200ResponseSummary} The populated <code>ApiV1StreamsStreamIdSummarizePost200ResponseSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1StreamsStreamIdSummarizePost200ResponseSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1StreamsStreamIdSummarizePost200ResponseSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1StreamsStreamIdSummarizePost200ResponseSummary</code>.
     */
...
/**
 * ID of new video summary
 * @member {String} _id
 */
ApiV1StreamsStreamIdSummarizePost200ResponseSummary.prototype['_id'] = undefined;

/**
 * ID of user who created video summary
 * @member {String} createdBy
 */
ApiV1StreamsStreamIdSummarizePost200ResponseSummary.prototype['createdBy'] = undefined;

/**
 * ID of stream being summarized
 * @member {String} feed
 */
ApiV1StreamsStreamIdSummarizePost200ResponseSummary.prototype['feed'] = undefined;

/**
 * Start time of video summary
 * @member {Date} startTime
 */
ApiV1StreamsStreamIdSummarizePost200ResponseSummary.prototype['startTime'] = undefined;

/**
 * End time of video summary
 * @member {Date} endTime
 */
ApiV1StreamsStreamIdSummarizePost200ResponseSummary.prototype['endTime'] = undefined;

/**
 * Current status of video summary
 * @member {String} state
 */
ApiV1StreamsStreamIdSummarizePost200ResponseSummary.prototype['state'] = undefined;

/**
 * Current progress of video summary
 * @member {Number} progress
 */
ApiV1StreamsStreamIdSummarizePost200ResponseSummary.prototype['progress'] = undefined;

/**
 * Localizer being used for detection
 * @member {String} network
 */
ApiV1StreamsStreamIdSummarizePost200ResponseSummary.prototype['network'] = undefined;
...
export default ApiV1StreamsStreamIdSummarizePost200ResponseSummary;
