...
/**
 * The ApiV1CollectionTasksTaskIdPutRequest model module.
 * @module model/ApiV1CollectionTasksTaskIdPutRequest
 * @version 1.0.0
 */
class ApiV1CollectionTasksTaskIdPutRequest {
    /**
     * Constructs a new <code>ApiV1CollectionTasksTaskIdPutRequest</code>.
     * @alias module:model/ApiV1CollectionTasksTaskIdPutRequest
     * @param updateIndex {Boolean} Whether to update the collection task
     */
    constructor(updateIndex) { 
        
        ApiV1CollectionTasksTaskIdPutRequest.initialize(this, updateIndex);
    }
     ...
     */
    static initialize(obj, updateIndex) { 
        obj['updateIndex'] = updateIndex;
    }

    /**
     * Constructs a <code>ApiV1CollectionTasksTaskIdPutRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1CollectionTasksTaskIdPutRequest} obj Optional instance to populate.
     * @return {module:model/ApiV1CollectionTasksTaskIdPutRequest} The populated <code>ApiV1CollectionTasksTaskIdPutRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1CollectionTasksTaskIdPutRequest();

            if (data.hasOwnProperty('updateIndex')) {
                obj['updateIndex'] = ApiClient.convertToType(data['updateIndex'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1CollectionTasksTaskIdPutRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1CollectionTasksTaskIdPutRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV1CollectionTasksTaskIdPutRequest.RequiredProperties) {
...
ApiV1CollectionTasksTaskIdPutRequest.RequiredProperties = ["updateIndex"];

/**
 * Whether to update the collection task
 * @member {Boolean} updateIndex
 */
ApiV1CollectionTasksTaskIdPutRequest.prototype['updateIndex'] = undefined;
...
export default ApiV1CollectionTasksTaskIdPutRequest;
