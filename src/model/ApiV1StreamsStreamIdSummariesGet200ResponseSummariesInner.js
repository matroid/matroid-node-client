...
/**
 * The ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner model module.
 * @module model/ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner
 * @version 1.0.0
 */
class ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner {
    /**
     * Constructs a new <code>ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner</code>.
     * @alias module:model/ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner
     */
    constructor() { 
        
        ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner} obj Optional instance to populate.
     * @return {module:model/ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner} The populated <code>ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner</code>.
     */
 ...
 * @member {String} _id
 */
ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner.prototype['_id'] = undefined;

/**
 * ID of the stream being summarized
 * @member {String} feed
 */
ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner.prototype['feed'] = undefined;

/**
 * Start time of the summary
 * @member {Date} startTime
 */
ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner.prototype['startTime'] = undefined;

/**
 * End time of the summary
 * @member {Date} endTime
 */
ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner.prototype['endTime'] = undefined;

/**
 * Progress of the summary
 * @member {Number} progress
 */
ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner.prototype['progress'] = undefined;
...
export default ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner;
