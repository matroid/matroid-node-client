...
/**
 * The ApiV1TemporalTasksTaskIdGet200Response model module.
 * @module model/ApiV1TemporalTasksTaskIdGet200Response
 * @version 1.0.0
 */
class ApiV1TemporalTasksTaskIdGet200Response {
    /**
     * Constructs a new <code>ApiV1TemporalTasksTaskIdGet200Response</code>.
     * @alias module:model/ApiV1TemporalTasksTaskIdGet200Response
     */
    constructor() { 
        
        ApiV1TemporalTasksTaskIdGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1TemporalTasksTaskIdGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1TemporalTasksTaskIdGet200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1TemporalTasksTaskIdGet200Response} The populated <code>ApiV1TemporalTasksTaskIdGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1TemporalTasksTaskIdGet200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1TemporalTasksTaskIdGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1TemporalTasksTaskIdGet200Response</code>.
     */
...
/**
 * Temporal Task progress fraction (0-1)
 * @member {Number} progress
 */
ApiV1TemporalTasksTaskIdGet200Response.prototype['progress'] = undefined;

/**
 * Temporal Task's current state
 * @member {String} state
 */
ApiV1TemporalTasksTaskIdGet200Response.prototype['state'] = undefined;

/**
 * Message describing the current Temporal Task process
 * @member {String} message
 */
ApiV1TemporalTasksTaskIdGet200Response.prototype['message'] = undefined;

/**
 * Network ID used for localization
 * @member {String} network
 */
ApiV1TemporalTasksTaskIdGet200Response.prototype['network'] = undefined;
...
export default ApiV1TemporalTasksTaskIdGet200Response;
