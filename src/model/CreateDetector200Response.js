...
/**
 * The CreateDetector200Response model module.
 * @module model/CreateDetector200Response
 * @version 1.0.0
 */
class CreateDetector200Response {
    /**
     * Constructs a new <code>CreateDetector200Response</code>.
     * @alias module:model/CreateDetector200Response
     */
    constructor() { 
        
        CreateDetector200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateDetector200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateDetector200Response} obj Optional instance to populate.
     * @return {module:model/CreateDetector200Response} The populated <code>CreateDetector200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateDetector200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateDetector200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateDetector200Response</code>.
     */
...
/**
 * Unique ID of the newly-created detector.
 * @member {String} detectorId
 */
CreateDetector200Response.prototype['detectorId'] = undefined;
...
export default CreateDetector200Response;
