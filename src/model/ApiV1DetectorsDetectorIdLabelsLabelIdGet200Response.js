...
import ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInner from './ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInner';

/**
 * The ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response model module.
 * @module model/ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response
 * @version 1.0.0
 */
class ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response {
    /**
     * Constructs a new <code>ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response</code>.
     * @alias module:model/ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response
     */
    constructor() { 
        
        ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response} The populated <code>ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response();

            if (data.hasOwnProperty('labelId')) {
                obj['labelId'] = ApiClient.convertToType(data['labelId'], 'String');
            }
            if (data.hasOwnProperty('images')) {
                obj['images'] = ApiClient.convertToType(data['images'], [ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['images']) { // data not null
            ...
            for (const item of data['images']) {
                ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInner.validateJSON(item);
            };
        }
 ...
 */
ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response.prototype['labelId'] = undefined;

/**
 * @member {Array.<module:model/ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInner>} images
 */
ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response.prototype['images'] = undefined;
...
export default ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response;
