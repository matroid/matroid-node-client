...
/**
 * The ApiV1CollectionTasksTaskIdPut200Response model module.
 * @module model/ApiV1CollectionTasksTaskIdPut200Response
 * @version 1.0.0
 */
class ApiV1CollectionTasksTaskIdPut200Response {
    /**
     * Constructs a new <code>ApiV1CollectionTasksTaskIdPut200Response</code>.
     * @alias module:model/ApiV1CollectionTasksTaskIdPut200Response
     */
    constructor() { 
        
        ApiV1CollectionTasksTaskIdPut200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1CollectionTasksTaskIdPut200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1CollectionTasksTaskIdPut200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1CollectionTasksTaskIdPut200Response} The populated <code>ApiV1CollectionTasksTaskIdPut200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1CollectionTasksTaskIdPut200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1CollectionTasksTaskIdPut200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1CollectionTasksTaskIdPut200Response</code>.
     */
...
/**
 * Updated collection task object
 * @member {Object} collectionTask
 */
ApiV1CollectionTasksTaskIdPut200Response.prototype['collectionTask'] = undefined;
...
export default ApiV1CollectionTasksTaskIdPut200Response;
