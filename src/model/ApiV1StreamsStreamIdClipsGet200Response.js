...
import ApiV1StreamsStreamIdClipsGet200ResponseClipsInner from './ApiV1StreamsStreamIdClipsGet200ResponseClipsInner';

/**
 * The ApiV1StreamsStreamIdClipsGet200Response model module.
 * @module model/ApiV1StreamsStreamIdClipsGet200Response
 * @version 1.0.0
 */
class ApiV1StreamsStreamIdClipsGet200Response {
    /**
     * Constructs a new <code>ApiV1StreamsStreamIdClipsGet200Response</code>.
     * @alias module:model/ApiV1StreamsStreamIdClipsGet200Response
     */
    constructor() { 
        
        ApiV1StreamsStreamIdClipsGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1StreamsStreamIdClipsGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1StreamsStreamIdClipsGet200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1StreamsStreamIdClipsGet200Response} The populated <code>ApiV1StreamsStreamIdClipsGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1StreamsStreamIdClipsGet200Response();

            if (data.hasOwnProperty('streamId')) {
                obj['streamId'] = ApiClient.convertToType(data['streamId'], 'String');
            }
            if (data.hasOwnProperty('clips')) {
                obj['clips'] = ApiClient.convertToType(data['clips'], [ApiV1StreamsStreamIdClipsGet200ResponseClipsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1StreamsStreamIdClipsGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1StreamsStreamIdClipsGet200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['clips']) { // data not null
            ...
            for (const item of data['clips']) {
                ApiV1StreamsStreamIdClipsGet200ResponseClipsInner.validateJSON(item);
            };
        }
 ...
 */
ApiV1StreamsStreamIdClipsGet200Response.prototype['streamId'] = undefined;

/**
 * @member {Array.<module:model/ApiV1StreamsStreamIdClipsGet200ResponseClipsInner>} clips
 */
ApiV1StreamsStreamIdClipsGet200Response.prototype['clips'] = undefined;
...
export default ApiV1StreamsStreamIdClipsGet200Response;
