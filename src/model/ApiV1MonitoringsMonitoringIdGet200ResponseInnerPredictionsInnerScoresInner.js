...
/**
 * The ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner model module.
 * @module model/ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner
 * @version 1.0.0
 */
class ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner {
    /**
     * Constructs a new <code>ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner</code>.
     * @alias module:model/ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner
     */
    constructor() { 
        
        ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner} obj Optional instance to populate.
     * @return {module:model/ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner} The populated <code>ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner</code>.
     */
 ...
 * @member {String} label
 */
ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner.prototype['label'] = undefined;

/**
 * Score for the given label
 * @member {String} score
 */
ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner.prototype['score'] = undefined;
...
export default ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner;
