...
/**
 * The ApiV1DatasetsDatasetIdLabelsPut200Response model module.
 * @module model/ApiV1DatasetsDatasetIdLabelsPut200Response
 * @version 1.0.0
 */
class ApiV1DatasetsDatasetIdLabelsPut200Response {
    /**
     * Constructs a new <code>ApiV1DatasetsDatasetIdLabelsPut200Response</code>.
     * @alias module:model/ApiV1DatasetsDatasetIdLabelsPut200Response
     */
    constructor() { 
        
        ApiV1DatasetsDatasetIdLabelsPut200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1DatasetsDatasetIdLabelsPut200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1DatasetsDatasetIdLabelsPut200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1DatasetsDatasetIdLabelsPut200Response} The populated <code>ApiV1DatasetsDatasetIdLabelsPut200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1DatasetsDatasetIdLabelsPut200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1DatasetsDatasetIdLabelsPut200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1DatasetsDatasetIdLabelsPut200Response</code>.
     */
 ...
 */
ApiV1DatasetsDatasetIdLabelsPut200Response.prototype['message'] = undefined;

/**
 * The updated list of label objects
 * @member {Array.<String>} labels
 */
ApiV1DatasetsDatasetIdLabelsPut200Response.prototype['labels'] = undefined;
...
export default ApiV1DatasetsDatasetIdLabelsPut200Response;
