...
/**
 * The ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner model module.
 * @module model/ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner
 * @version 1.0.0
 */
class ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner {
    /**
     * Constructs a new <code>ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner</code>.
     * @alias module:model/ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner
     */
    constructor() { 
        
        ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner} obj Optional instance to populate.
     * @return {module:model/ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner} The populated <code>ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner();

            if (data.hasOwnProperty('_id')) {
                obj['_id'] = ApiClient.convertToType(data['_id'], 'String');
            }
            if (data.hasOwnProperty('detection')) {
                obj['detection'] = ApiClient.convertToType(data['detection'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner</code>.
     */
 ...
 * @member {String} _id
 */
ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner.prototype['_id'] = undefined;

/**
 * Detection settings for the monitoring
 * @member {Object} detection
 */
ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner.prototype['detection'] = undefined;
...
export default ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner;
