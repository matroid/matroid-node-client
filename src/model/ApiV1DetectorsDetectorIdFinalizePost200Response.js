...
/**
 * The ApiV1DetectorsDetectorIdFinalizePost200Response model module.
 * @module model/ApiV1DetectorsDetectorIdFinalizePost200Response
 * @version 1.0.0
 */
class ApiV1DetectorsDetectorIdFinalizePost200Response {
    /**
     * Constructs a new <code>ApiV1DetectorsDetectorIdFinalizePost200Response</code>.
     * @alias module:model/ApiV1DetectorsDetectorIdFinalizePost200Response
     */
    constructor() { 
        
        ApiV1DetectorsDetectorIdFinalizePost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1DetectorsDetectorIdFinalizePost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1DetectorsDetectorIdFinalizePost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1DetectorsDetectorIdFinalizePost200Response} The populated <code>ApiV1DetectorsDetectorIdFinalizePost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1DetectorsDetectorIdFinalizePost200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1DetectorsDetectorIdFinalizePost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1DetectorsDetectorIdFinalizePost200Response</code>.
     */
...
/**
 * Unique ID of the detector being trained
 * @member {String} detectorId
 */
ApiV1DetectorsDetectorIdFinalizePost200Response.prototype['detectorId'] = undefined;

/**
 * Status of the training process
 * @member {String} status
 */
ApiV1DetectorsDetectorIdFinalizePost200Response.prototype['status'] = undefined;
...
export default ApiV1DetectorsDetectorIdFinalizePost200Response;
