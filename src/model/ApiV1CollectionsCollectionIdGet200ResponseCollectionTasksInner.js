...
/**
 * The ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner model module.
 * @module model/ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner
 * @version 1.0.0
 */
class ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner {
    /**
     * Constructs a new <code>ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner</code>.
     * @alias module:model/ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner
     */
    constructor() { 
        
        ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner} obj Optional instance to populate.
     * @return {module:model/ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner} The populated <code>ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner</code>.
     */
 ...
 * @member {String} _id
 */
ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner.prototype['_id'] = undefined;

/**
 * Task state
 * @member {String} state
 */
ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner.prototype['state'] = undefined;

/**
 * Task progress (0-1)
 * @member {Number} progress
 */
ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner.prototype['progress'] = undefined;
...
export default ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner;
