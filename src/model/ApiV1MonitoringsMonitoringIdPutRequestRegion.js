...
/**
 * The ApiV1MonitoringsMonitoringIdPutRequestRegion model module.
 * @module model/ApiV1MonitoringsMonitoringIdPutRequestRegion
 * @version 1.0.0
 */
class ApiV1MonitoringsMonitoringIdPutRequestRegion {
    /**
     * Constructs a new <code>ApiV1MonitoringsMonitoringIdPutRequestRegion</code>.
     * @alias module:model/ApiV1MonitoringsMonitoringIdPutRequestRegion
     */
    constructor() { 
        
        ApiV1MonitoringsMonitoringIdPutRequestRegion.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MonitoringsMonitoringIdPutRequestRegion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MonitoringsMonitoringIdPutRequestRegion} obj Optional instance to populate.
     * @return {module:model/ApiV1MonitoringsMonitoringIdPutRequestRegion} The populated <code>ApiV1MonitoringsMonitoringIdPutRequestRegion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MonitoringsMonitoringIdPutRequestRegion();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MonitoringsMonitoringIdPutRequestRegion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MonitoringsMonitoringIdPutRequestRegion</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['coords'])) {
            throw new Error("Expected the field `coords` to be an array in the JSON data but got " + data['coords']);
        }
...
/**
 * Whether to use focus area or not
 * @member {Boolean} enabled
 */
ApiV1MonitoringsMonitoringIdPutRequestRegion.prototype['enabled'] = undefined;

/**
 * Strings representing x,y coordinates (ex: [\"x0,y0\", \"x1,y1\", \"x2,y2\", ...])
 * @member {Array.<String>} coords
 */
ApiV1MonitoringsMonitoringIdPutRequestRegion.prototype['coords'] = undefined;
...
export default ApiV1MonitoringsMonitoringIdPutRequestRegion;
