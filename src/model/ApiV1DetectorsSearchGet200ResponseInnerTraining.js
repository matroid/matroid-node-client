...
/**
 * The ApiV1DetectorsSearchGet200ResponseInnerTraining model module.
 * @module model/ApiV1DetectorsSearchGet200ResponseInnerTraining
 * @version 1.0.0
 */
class ApiV1DetectorsSearchGet200ResponseInnerTraining {
    /**
     * Constructs a new <code>ApiV1DetectorsSearchGet200ResponseInnerTraining</code>.
     * Training progress and status
     * @alias module:model/ApiV1DetectorsSearchGet200ResponseInnerTraining
     */
    constructor() { 
        
        ApiV1DetectorsSearchGet200ResponseInnerTraining.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1DetectorsSearchGet200ResponseInnerTraining</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1DetectorsSearchGet200ResponseInnerTraining} obj Optional instance to populate.
     * @return {module:model/ApiV1DetectorsSearchGet200ResponseInnerTraining} The populated <code>ApiV1DetectorsSearchGet200ResponseInnerTraining</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1DetectorsSearchGet200ResponseInnerTraining();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1DetectorsSearchGet200ResponseInnerTraining</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1DetectorsSearchGet200ResponseInnerTraining</code>.
     */
 ...
 */
ApiV1DetectorsSearchGet200ResponseInnerTraining.prototype['accuracy'] = undefined;
...
export default ApiV1DetectorsSearchGet200ResponseInnerTraining;
