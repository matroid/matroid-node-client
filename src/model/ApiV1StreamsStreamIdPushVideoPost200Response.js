...
/**
 * The ApiV1StreamsStreamIdPushVideoPost200Response model module.
 * @module model/ApiV1StreamsStreamIdPushVideoPost200Response
 * @version 1.0.0
 */
class ApiV1StreamsStreamIdPushVideoPost200Response {
    /**
     * Constructs a new <code>ApiV1StreamsStreamIdPushVideoPost200Response</code>.
     * @alias module:model/ApiV1StreamsStreamIdPushVideoPost200Response
     */
    constructor() { 
        
        ApiV1StreamsStreamIdPushVideoPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1StreamsStreamIdPushVideoPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1StreamsStreamIdPushVideoPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1StreamsStreamIdPushVideoPost200Response} The populated <code>ApiV1StreamsStreamIdPushVideoPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1StreamsStreamIdPushVideoPost200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1StreamsStreamIdPushVideoPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1StreamsStreamIdPushVideoPost200Response</code>.
     */
...
/**
 * ID of the TemporalTask that is inserting the video into the stream history
 * @member {String} taskId
 */
ApiV1StreamsStreamIdPushVideoPost200Response.prototype['taskId'] = undefined;

/**
 * ID of the created video
 * @member {String} videoId
 */
ApiV1StreamsStreamIdPushVideoPost200Response.prototype['videoId'] = undefined;
...
export default ApiV1StreamsStreamIdPushVideoPost200Response;
