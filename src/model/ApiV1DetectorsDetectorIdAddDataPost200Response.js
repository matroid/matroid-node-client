...
/**
 * The ApiV1DetectorsDetectorIdAddDataPost200Response model module.
 * @module model/ApiV1DetectorsDetectorIdAddDataPost200Response
 * @version 1.0.0
 */
class ApiV1DetectorsDetectorIdAddDataPost200Response {
    /**
     * Constructs a new <code>ApiV1DetectorsDetectorIdAddDataPost200Response</code>.
     * @alias module:model/ApiV1DetectorsDetectorIdAddDataPost200Response
     */
    constructor() { 
        
        ApiV1DetectorsDetectorIdAddDataPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1DetectorsDetectorIdAddDataPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1DetectorsDetectorIdAddDataPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1DetectorsDetectorIdAddDataPost200Response} The populated <code>ApiV1DetectorsDetectorIdAddDataPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1DetectorsDetectorIdAddDataPost200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1DetectorsDetectorIdAddDataPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1DetectorsDetectorIdAddDataPost200Response</code>.
     */
 ...
 */
ApiV1DetectorsDetectorIdAddDataPost200Response.prototype['success'] = undefined;

/**
 * @member {String} message
 */
ApiV1DetectorsDetectorIdAddDataPost200Response.prototype['message'] = undefined;

/**
 * Number of images that failed to upload (if any).
 * @member {Number} failedCount
 */
ApiV1DetectorsDetectorIdAddDataPost200Response.prototype['failedCount'] = undefined;
...
export default ApiV1DetectorsDetectorIdAddDataPost200Response;
