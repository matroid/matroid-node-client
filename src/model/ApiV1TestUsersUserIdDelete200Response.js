...
/**
 * The ApiV1TestUsersUserIdDelete200Response model module.
 * @module model/ApiV1TestUsersUserIdDelete200Response
 * @version 1.0.0
 */
class ApiV1TestUsersUserIdDelete200Response {
    /**
     * Constructs a new <code>ApiV1TestUsersUserIdDelete200Response</code>.
     * @alias module:model/ApiV1TestUsersUserIdDelete200Response
     */
    constructor() { 
        
        ApiV1TestUsersUserIdDelete200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1TestUsersUserIdDelete200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1TestUsersUserIdDelete200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1TestUsersUserIdDelete200Response} The populated <code>ApiV1TestUsersUserIdDelete200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1TestUsersUserIdDelete200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1TestUsersUserIdDelete200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1TestUsersUserIdDelete200Response</code>.
     */
 ...
 * @member {Object} user
 */
ApiV1TestUsersUserIdDelete200Response.prototype['user'] = undefined;

/**
 * Success message
 * @member {String} message
 */
ApiV1TestUsersUserIdDelete200Response.prototype['message'] = undefined;
...
export default ApiV1TestUsersUserIdDelete200Response;
