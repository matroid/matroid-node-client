...
import ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner from './ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner';

/**
 * The ApiV1ImagesAnnotationsGet200Response model module.
 * @module model/ApiV1ImagesAnnotationsGet200Response
 * @version 1.0.0
 */
class ApiV1ImagesAnnotationsGet200Response {
    /**
     * Constructs a new <code>ApiV1ImagesAnnotationsGet200Response</code>.
     * @alias module:model/ApiV1ImagesAnnotationsGet200Response
     */
    constructor() { 
        
        ApiV1ImagesAnnotationsGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1ImagesAnnotationsGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1ImagesAnnotationsGet200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1ImagesAnnotationsGet200Response} The populated <code>ApiV1ImagesAnnotationsGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1ImagesAnnotationsGet200Response();

            if (data.hasOwnProperty('annotations')) {
                obj['annotations'] = ApiClient.convertToType(data['annotations'], [ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1ImagesAnnotationsGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1ImagesAnnotationsGet200Response</code>.
     */
    static validateJSON(data) {
        if (data['annotations']) { // data not null
            ...
            for (const item of data['annotations']) {
                ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner>} annotations
 */
ApiV1ImagesAnnotationsGet200Response.prototype['annotations'] = undefined;
...
export default ApiV1ImagesAnnotationsGet200Response;
