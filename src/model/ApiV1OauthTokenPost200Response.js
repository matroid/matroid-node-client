...
/**
 * The ApiV1OauthTokenPost200Response model module.
 * @module model/ApiV1OauthTokenPost200Response
 * @version 1.0.0
 */
class ApiV1OauthTokenPost200Response {
    /**
     * Constructs a new <code>ApiV1OauthTokenPost200Response</code>.
     * @alias module:model/ApiV1OauthTokenPost200Response
     */
    constructor() { 
        
        ApiV1OauthTokenPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1OauthTokenPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1OauthTokenPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1OauthTokenPost200Response} The populated <code>ApiV1OauthTokenPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1OauthTokenPost200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1OauthTokenPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1OauthTokenPost200Response</code>.
     */
 ...
 */
ApiV1OauthTokenPost200Response.prototype['access_token'] = undefined;

/**
 * The type of token (Bearer)
 * @member {String} token_type
 */
ApiV1OauthTokenPost200Response.prototype['token_type'] = undefined;

/**
 * Token expiration time in seconds
 * @member {Number} expires_in
 */
ApiV1OauthTokenPost200Response.prototype['expires_in'] = undefined;
...
export default ApiV1OauthTokenPost200Response;
