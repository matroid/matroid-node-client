...
/**
 * The ApiV1MonitoringsGet200ResponseInnerRegion model module.
 * @module model/ApiV1MonitoringsGet200ResponseInnerRegion
 * @version 1.0.0
 */
class ApiV1MonitoringsGet200ResponseInnerRegion {
    /**
     * Constructs a new <code>ApiV1MonitoringsGet200ResponseInnerRegion</code>.
     * Bounding box object with left, top, width, height if focus area is enabled
     * @alias module:model/ApiV1MonitoringsGet200ResponseInnerRegion
     */
    constructor() { 
        
        ApiV1MonitoringsGet200ResponseInnerRegion.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MonitoringsGet200ResponseInnerRegion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MonitoringsGet200ResponseInnerRegion} obj Optional instance to populate.
     * @return {module:model/ApiV1MonitoringsGet200ResponseInnerRegion} The populated <code>ApiV1MonitoringsGet200ResponseInnerRegion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MonitoringsGet200ResponseInnerRegion();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MonitoringsGet200ResponseInnerRegion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MonitoringsGet200ResponseInnerRegion</code>.
     */
 ...
 * @member {Number} left
 */
ApiV1MonitoringsGet200ResponseInnerRegion.prototype['left'] = undefined;

/**
 * @member {Number} top
 */
ApiV1MonitoringsGet200ResponseInnerRegion.prototype['top'] = undefined;

/**
 * @member {Number} width
 */
ApiV1MonitoringsGet200ResponseInnerRegion.prototype['width'] = undefined;

/**
 * @member {Number} height
 */
ApiV1MonitoringsGet200ResponseInnerRegion.prototype['height'] = undefined;
...
export default ApiV1MonitoringsGet200ResponseInnerRegion;
