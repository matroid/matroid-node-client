...
import ApiV1CollectionTasksTaskIdKillPost200ResponseCollection from './ApiV1CollectionTasksTaskIdKillPost200ResponseCollection';

/**
 * The ApiV1CollectionTasksTaskIdKillPost200Response model module.
 * @module model/ApiV1CollectionTasksTaskIdKillPost200Response
 * @version 1.0.0
 */
class ApiV1CollectionTasksTaskIdKillPost200Response {
    /**
     * Constructs a new <code>ApiV1CollectionTasksTaskIdKillPost200Response</code>.
     * @alias module:model/ApiV1CollectionTasksTaskIdKillPost200Response
     */
    constructor() { 
        
        ApiV1CollectionTasksTaskIdKillPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1CollectionTasksTaskIdKillPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1CollectionTasksTaskIdKillPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1CollectionTasksTaskIdKillPost200Response} The populated <code>ApiV1CollectionTasksTaskIdKillPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1CollectionTasksTaskIdKillPost200Response();

            if (data.hasOwnProperty('taskId')) {
                obj['taskId'] = ApiClient.convertToType(data['taskId'], 'String');
            }
            if (data.hasOwnProperty('collection')) {
                obj['collection'] = ApiV1CollectionTasksTaskIdKillPost200ResponseCollection.constructFromObject(data['collection']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1CollectionTasksTaskIdKillPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1CollectionTasksTaskIdKillPost200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['collection']) { // data not null
          ApiV1CollectionTasksTaskIdKillPost200ResponseCollection.validateJSON(data['collection']);
        }
...
/**
 * Unique ID of the killed collection task
 * @member {String} taskId
 */
ApiV1CollectionTasksTaskIdKillPost200Response.prototype['taskId'] = undefined;

/**
 * @member {module:model/ApiV1CollectionTasksTaskIdKillPost200ResponseCollection} collection
 */
ApiV1CollectionTasksTaskIdKillPost200Response.prototype['collection'] = undefined;
...
export default ApiV1CollectionTasksTaskIdKillPost200Response;
