...
/**
 * The ApiV1CollectionTasksTaskIdDelete200Response model module.
 * @module model/ApiV1CollectionTasksTaskIdDelete200Response
 * @version 1.0.0
 */
class ApiV1CollectionTasksTaskIdDelete200Response {
    /**
     * Constructs a new <code>ApiV1CollectionTasksTaskIdDelete200Response</code>.
     * @alias module:model/ApiV1CollectionTasksTaskIdDelete200Response
     */
    constructor() { 
        
        ApiV1CollectionTasksTaskIdDelete200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1CollectionTasksTaskIdDelete200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1CollectionTasksTaskIdDelete200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1CollectionTasksTaskIdDelete200Response} The populated <code>ApiV1CollectionTasksTaskIdDelete200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1CollectionTasksTaskIdDelete200Response();

            if (data.hasOwnProperty('collectionTask')) {
                obj['collectionTask'] = ApiClient.convertToType(data['collectionTask'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1CollectionTasksTaskIdDelete200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1CollectionTasksTaskIdDelete200Response</code>.
     */
...
/**
 * Deleted collection task details
 * @member {Object} collectionTask
 */
ApiV1CollectionTasksTaskIdDelete200Response.prototype['collectionTask'] = undefined;
...
export default ApiV1CollectionTasksTaskIdDelete200Response;
