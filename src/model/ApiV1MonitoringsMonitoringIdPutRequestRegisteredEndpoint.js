...
/**
 * The ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint model module.
 * @module model/ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint
 * @version 1.0.0
 */
class ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint {
    /**
     * Constructs a new <code>ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint</code>.
     * @alias module:model/ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint
     */
    constructor() { 
        
        ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint} obj Optional instance to populate.
     * @return {module:model/ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint} The populated <code>ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint</code>.
     */
...
/**
 * Endpoint to send detection notification info to
 * @member {String} uri
 */
ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint.prototype['uri'] = undefined;
...
export default ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint;
