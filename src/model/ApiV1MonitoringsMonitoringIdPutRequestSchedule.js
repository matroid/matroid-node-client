...
/**
 * The ApiV1MonitoringsMonitoringIdPutRequestSchedule model module.
 * @module model/ApiV1MonitoringsMonitoringIdPutRequestSchedule
 * @version 1.0.0
 */
class ApiV1MonitoringsMonitoringIdPutRequestSchedule {
    /**
     * Constructs a new <code>ApiV1MonitoringsMonitoringIdPutRequestSchedule</code>.
     * @alias module:model/ApiV1MonitoringsMonitoringIdPutRequestSchedule
     */
    constructor() { 
        
        ApiV1MonitoringsMonitoringIdPutRequestSchedule.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MonitoringsMonitoringIdPutRequestSchedule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MonitoringsMonitoringIdPutRequestSchedule} obj Optional instance to populate.
     * @return {module:model/ApiV1MonitoringsMonitoringIdPutRequestSchedule} The populated <code>ApiV1MonitoringsMonitoringIdPutRequestSchedule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MonitoringsMonitoringIdPutRequestSchedule();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MonitoringsMonitoringIdPutRequestSchedule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MonitoringsMonitoringIdPutRequestSchedule</code>.
     */
...
/**
 * New time to begin monitoring (must be future)
 * @member {Date} startTime
 */
ApiV1MonitoringsMonitoringIdPutRequestSchedule.prototype['startTime'] = undefined;

/**
 * New time to end monitoring (must be future and after startTime)
 * @member {Date} endTime
 */
ApiV1MonitoringsMonitoringIdPutRequestSchedule.prototype['endTime'] = undefined;
...
export default ApiV1MonitoringsMonitoringIdPutRequestSchedule;
