...
import ApiV1StreamsStreamIdSummarizePost200ResponseSummary from './ApiV1StreamsStreamIdSummarizePost200ResponseSummary';

/**
 * The ApiV1StreamsStreamIdSummarizePost200Response model module.
 * @module model/ApiV1StreamsStreamIdSummarizePost200Response
 * @version 1.0.0
 */
class ApiV1StreamsStreamIdSummarizePost200Response {
    /**
     * Constructs a new <code>ApiV1StreamsStreamIdSummarizePost200Response</code>.
     * @alias module:model/ApiV1StreamsStreamIdSummarizePost200Response
     */
    constructor() { 
        
        ApiV1StreamsStreamIdSummarizePost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1StreamsStreamIdSummarizePost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1StreamsStreamIdSummarizePost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1StreamsStreamIdSummarizePost200Response} The populated <code>ApiV1StreamsStreamIdSummarizePost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1StreamsStreamIdSummarizePost200Response();

            if (data.hasOwnProperty('summary')) {
                obj['summary'] = ApiV1StreamsStreamIdSummarizePost200ResponseSummary.constructFromObject(data['summary']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1StreamsStreamIdSummarizePost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1StreamsStreamIdSummarizePost200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `summary`
        if (data['summary']) { // data not null
          ApiV1StreamsStreamIdSummarizePost200ResponseSummary.validateJSON(data['summary']);
        }
...
/**
 * @member {module:model/ApiV1StreamsStreamIdSummarizePost200ResponseSummary} summary
 */
ApiV1StreamsStreamIdSummarizePost200Response.prototype['summary'] = undefined;
...
export default ApiV1StreamsStreamIdSummarizePost200Response;
