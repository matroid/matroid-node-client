...
/**
 * The ApiV1StreamsBatchPostRequest1DetectorsInner model module.
 * @module model/ApiV1StreamsBatchPostRequest1DetectorsInner
 * @version 1.0.0
 */
class ApiV1StreamsBatchPostRequest1DetectorsInner {
    /**
     * Constructs a new <code>ApiV1StreamsBatchPostRequest1DetectorsInner</code>.
     * @alias module:model/ApiV1StreamsBatchPostRequest1DetectorsInner
     */
    constructor() { 
        
        ApiV1StreamsBatchPostRequest1DetectorsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1StreamsBatchPostRequest1DetectorsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1StreamsBatchPostRequest1DetectorsInner} obj Optional instance to populate.
     * @return {module:model/ApiV1StreamsBatchPostRequest1DetectorsInner} The populated <code>ApiV1StreamsBatchPostRequest1DetectorsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1StreamsBatchPostRequest1DetectorsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1StreamsBatchPostRequest1DetectorsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1StreamsBatchPostRequest1DetectorsInner</code>.
     */
...
/**
 * ID of the detector to use
 * @member {String} detectorId
 */
ApiV1StreamsBatchPostRequest1DetectorsInner.prototype['detectorId'] = undefined;

/**
 * Detection thresholds for each label
 * @member {Object.<String, Number>} thresholds
 */
ApiV1StreamsBatchPostRequest1DetectorsInner.prototype['thresholds'] = undefined;
...
export default ApiV1StreamsBatchPostRequest1DetectorsInner;
