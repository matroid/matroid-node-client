...
/**
 * The ApiV1DetectorsDetectorIdClassifyVideoPost200Response model module.
 * @module model/ApiV1DetectorsDetectorIdClassifyVideoPost200Response
 * @version 1.0.0
 */
class ApiV1DetectorsDetectorIdClassifyVideoPost200Response {
    /**
     * Constructs a new <code>ApiV1DetectorsDetectorIdClassifyVideoPost200Response</code>.
     * @alias module:model/ApiV1DetectorsDetectorIdClassifyVideoPost200Response
     */
    constructor() { 
        
        ApiV1DetectorsDetectorIdClassifyVideoPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1DetectorsDetectorIdClassifyVideoPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1DetectorsDetectorIdClassifyVideoPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1DetectorsDetectorIdClassifyVideoPost200Response} The populated <code>ApiV1DetectorsDetectorIdClassifyVideoPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1DetectorsDetectorIdClassifyVideoPost200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1DetectorsDetectorIdClassifyVideoPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1DetectorsDetectorIdClassifyVideoPost200Response</code>.
     */
...
/**
 * Unique ID of the classified video
 * @member {String} videoId
 */
ApiV1DetectorsDetectorIdClassifyVideoPost200Response.prototype['videoId'] = undefined;

/**
 * Task ID for tracking the classification progress
 * @member {String} taskId
 */
ApiV1DetectorsDetectorIdClassifyVideoPost200Response.prototype['taskId'] = undefined;
...
export default ApiV1DetectorsDetectorIdClassifyVideoPost200Response;
