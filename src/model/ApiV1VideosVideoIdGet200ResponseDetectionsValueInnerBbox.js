...
/**
 * The ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox model module.
 * @module model/ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox
 * @version 1.0.0
 */
class ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox {
    /**
     * Constructs a new <code>ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox</code>.
     * Bounding box coordinates
     * @alias module:model/ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox
     */
    constructor() { 
        
        ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox} obj Optional instance to populate.
     * @return {module:model/ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox} The populated <code>ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox</code>.
     */
 ...
 * @member {Number} width
 */
ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox.prototype['width'] = undefined;

/**
 * @member {Number} top
 */
ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox.prototype['top'] = undefined;

/**
 * @member {Number} height
 */
ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox.prototype['height'] = undefined;

/**
 * @member {Number} left
 */
ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox.prototype['left'] = undefined;
...
export default ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox;
