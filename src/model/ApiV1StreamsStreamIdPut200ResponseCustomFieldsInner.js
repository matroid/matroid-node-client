...
/**
 * The ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner model module.
 * @module model/ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner
 * @version 1.0.0
 */
class ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner {
    /**
     * Constructs a new <code>ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner</code>.
     * @alias module:model/ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner
     */
    constructor() { 
        
        ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner} obj Optional instance to populate.
     * @return {module:model/ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner} The populated <code>ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner</code>.
     */
 ...
 * @member {String} key
 */
ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner.prototype['key'] = undefined;

/**
 * @member {String} template
 */
ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner.prototype['template'] = undefined;

/**
 * @member {String} _id
 */
ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner.prototype['_id'] = undefined;
...
export default ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner;
