...
/**
 * The ApiV1StreamsStreamIdPushImagePost200Response model module.
 * @module model/ApiV1StreamsStreamIdPushImagePost200Response
 * @version 1.0.0
 */
class ApiV1StreamsStreamIdPushImagePost200Response {
    /**
     * Constructs a new <code>ApiV1StreamsStreamIdPushImagePost200Response</code>.
     * @alias module:model/ApiV1StreamsStreamIdPushImagePost200Response
     */
    constructor() { 
        
        ApiV1StreamsStreamIdPushImagePost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1StreamsStreamIdPushImagePost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1StreamsStreamIdPushImagePost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1StreamsStreamIdPushImagePost200Response} The populated <code>ApiV1StreamsStreamIdPushImagePost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1StreamsStreamIdPushImagePost200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1StreamsStreamIdPushImagePost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1StreamsStreamIdPushImagePost200Response</code>.
     */
...
/**
 * Whether image was successfully pushed to stream
 * @member {Boolean} success
 */
ApiV1StreamsStreamIdPushImagePost200Response.prototype['success'] = undefined;
...
export default ApiV1StreamsStreamIdPushImagePost200Response;
