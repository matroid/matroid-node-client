...
/**
 * The ApiV1StreamsStreamIdMonitorDetectorIdPost200Response model module.
 * @module model/ApiV1StreamsStreamIdMonitorDetectorIdPost200Response
 * @version 1.0.0
 */
class ApiV1StreamsStreamIdMonitorDetectorIdPost200Response {
    /**
     * Constructs a new <code>ApiV1StreamsStreamIdMonitorDetectorIdPost200Response</code>.
     * @alias module:model/ApiV1StreamsStreamIdMonitorDetectorIdPost200Response
     */
    constructor() { 
        
        ApiV1StreamsStreamIdMonitorDetectorIdPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1StreamsStreamIdMonitorDetectorIdPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1StreamsStreamIdMonitorDetectorIdPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV1StreamsStreamIdMonitorDetectorIdPost200Response} The populated <code>ApiV1StreamsStreamIdMonitorDetectorIdPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1StreamsStreamIdMonitorDetectorIdPost200Response();
            ...
            if (data.hasOwnProperty('highFrequencyDetections')) {
                obj['highFrequencyDetections'] = ApiClient.convertToType(data['highFrequencyDetections'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1StreamsStreamIdMonitorDetectorIdPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1StreamsStreamIdMonitorDetectorIdPost200Response</code>.
     */
 ...
 */
ApiV1StreamsStreamIdMonitorDetectorIdPost200Response.prototype['streamId'] = undefined;

/**
 * Unique ID of the newly-created monitoring
 * @member {String} monitoringId
 */
ApiV1StreamsStreamIdMonitorDetectorIdPost200Response.prototype['monitoringId'] = undefined;

/**
 * Whether high-frequency detections are enabled
 * @member {Boolean} highFrequencyDetections
 */
ApiV1StreamsStreamIdMonitorDetectorIdPost200Response.prototype['highFrequencyDetections'] = undefined;
...
export default ApiV1StreamsStreamIdMonitorDetectorIdPost200Response;
