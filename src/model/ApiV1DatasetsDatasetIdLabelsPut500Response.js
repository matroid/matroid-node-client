...
/**
 * The ApiV1DatasetsDatasetIdLabelsPut500Response model module.
 * @module model/ApiV1DatasetsDatasetIdLabelsPut500Response
 * @version 1.0.0
 */
class ApiV1DatasetsDatasetIdLabelsPut500Response {
    /**
     * Constructs a new <code>ApiV1DatasetsDatasetIdLabelsPut500Response</code>.
     * @alias module:model/ApiV1DatasetsDatasetIdLabelsPut500Response
     */
    constructor() { 
        
        ApiV1DatasetsDatasetIdLabelsPut500Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1DatasetsDatasetIdLabelsPut500Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1DatasetsDatasetIdLabelsPut500Response} obj Optional instance to populate.
     * @return {module:model/ApiV1DatasetsDatasetIdLabelsPut500Response} The populated <code>ApiV1DatasetsDatasetIdLabelsPut500Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1DatasetsDatasetIdLabelsPut500Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1DatasetsDatasetIdLabelsPut500Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1DatasetsDatasetIdLabelsPut500Response</code>.
     */
 ...
 */
ApiV1DatasetsDatasetIdLabelsPut500Response.prototype['message'] = undefined;
...
export default ApiV1DatasetsDatasetIdLabelsPut500Response;
