...
/**
 * The ApiV1DatasetsDatasetIdLabelsPut404Response model module.
 * @module model/ApiV1DatasetsDatasetIdLabelsPut404Response
 * @version 1.0.0
 */
class ApiV1DatasetsDatasetIdLabelsPut404Response {
    /**
     * Constructs a new <code>ApiV1DatasetsDatasetIdLabelsPut404Response</code>.
     * @alias module:model/ApiV1DatasetsDatasetIdLabelsPut404Response
     */
    constructor() { 
        
        ApiV1DatasetsDatasetIdLabelsPut404Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1DatasetsDatasetIdLabelsPut404Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1DatasetsDatasetIdLabelsPut404Response} obj Optional instance to populate.
     * @return {module:model/ApiV1DatasetsDatasetIdLabelsPut404Response} The populated <code>ApiV1DatasetsDatasetIdLabelsPut404Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1DatasetsDatasetIdLabelsPut404Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1DatasetsDatasetIdLabelsPut404Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1DatasetsDatasetIdLabelsPut404Response</code>.
     */
 ...
 */
ApiV1DatasetsDatasetIdLabelsPut404Response.prototype['message'] = undefined;
...
export default ApiV1DatasetsDatasetIdLabelsPut404Response;
