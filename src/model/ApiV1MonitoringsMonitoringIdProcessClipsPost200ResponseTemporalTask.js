...
/**
 * The ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask model module.
 * @module model/ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask
 * @version 1.0.0
 */
class ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask {
    /**
     * Constructs a new <code>ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask</code>.
     * @alias module:model/ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask
     */
    constructor() { 
        
        ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask} obj Optional instance to populate.
     * @return {module:model/ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask} The populated <code>ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask</code>.
     */
 ...
 * @member {String} _id
 */
ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask.prototype['_id'] = undefined;

/**
 * ID of user who created temporal task
 * @member {String} createdBy
 */
ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask.prototype['createdBy'] = undefined;

/**
 * ID of stream being sampled
 * @member {String} feed
 */
ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask.prototype['feed'] = undefined;
...
export default ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask;
