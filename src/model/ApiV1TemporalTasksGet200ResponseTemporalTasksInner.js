...
/**
 * The ApiV1TemporalTasksGet200ResponseTemporalTasksInner model module.
 * @module model/ApiV1TemporalTasksGet200ResponseTemporalTasksInner
 * @version 1.0.0
 */
class ApiV1TemporalTasksGet200ResponseTemporalTasksInner {
    /**
     * Constructs a new <code>ApiV1TemporalTasksGet200ResponseTemporalTasksInner</code>.
     * @alias module:model/ApiV1TemporalTasksGet200ResponseTemporalTasksInner
     */
    constructor() { 
        
        ApiV1TemporalTasksGet200ResponseTemporalTasksInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1TemporalTasksGet200ResponseTemporalTasksInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1TemporalTasksGet200ResponseTemporalTasksInner} obj Optional instance to populate.
     * @return {module:model/ApiV1TemporalTasksGet200ResponseTemporalTasksInner} The populated <code>ApiV1TemporalTasksGet200ResponseTemporalTasksInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1TemporalTasksGet200ResponseTemporalTasksInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1TemporalTasksGet200ResponseTemporalTasksInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1TemporalTasksGet200ResponseTemporalTasksInner</code>.
     */
...
/**
 * ID of the temporal task
 * @member {String} _id
 */
ApiV1TemporalTasksGet200ResponseTemporalTasksInner.prototype['_id'] = undefined;

/**
 * ID of the user who created the task
 * @member {String} createdBy
 */
ApiV1TemporalTasksGet200ResponseTemporalTasksInner.prototype['createdBy'] = undefined;

/**
 * Current status of the task
 * @member {String} state
 */
ApiV1TemporalTasksGet200ResponseTemporalTasksInner.prototype['state'] = undefined;

/**
 * ID of the video being processed
 * @member {String} video
 */
ApiV1TemporalTasksGet200ResponseTemporalTasksInner.prototype['video'] = undefined;

/**
 * ID of the network being used
 * @member {String} network
 */
ApiV1TemporalTasksGet200ResponseTemporalTasksInner.prototype['network'] = undefined;

/**
 * Creation timestamp
 * @member {Date} createdAt
 */
ApiV1TemporalTasksGet200ResponseTemporalTasksInner.prototype['createdAt'] = undefined;

/**
 * Last update timestamp
 * @member {Date} updatedAt
 */
ApiV1TemporalTasksGet200ResponseTemporalTasksInner.prototype['updatedAt'] = undefined;
...
export default ApiV1TemporalTasksGet200ResponseTemporalTasksInner;
