...
/**
 * The ApiV1CollectionTasksTaskIdKillPost200ResponseCollection model module.
 * @module model/ApiV1CollectionTasksTaskIdKillPost200ResponseCollection
 * @version 1.0.0
 */
class ApiV1CollectionTasksTaskIdKillPost200ResponseCollection {
    /**
     * Constructs a new <code>ApiV1CollectionTasksTaskIdKillPost200ResponseCollection</code>.
     * Collection information (if includeCollectionInfo is true)
     * @alias module:model/ApiV1CollectionTasksTaskIdKillPost200ResponseCollection
     */
    constructor() { 
        
        ApiV1CollectionTasksTaskIdKillPost200ResponseCollection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1CollectionTasksTaskIdKillPost200ResponseCollection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1CollectionTasksTaskIdKillPost200ResponseCollection} obj Optional instance to populate.
     * @return {module:model/ApiV1CollectionTasksTaskIdKillPost200ResponseCollection} The populated <code>ApiV1CollectionTasksTaskIdKillPost200ResponseCollection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1CollectionTasksTaskIdKillPost200ResponseCollection();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1CollectionTasksTaskIdKillPost200ResponseCollection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1CollectionTasksTaskIdKillPost200ResponseCollection</code>.
     */
 ...
 * @member {String} _id
 */
ApiV1CollectionTasksTaskIdKillPost200ResponseCollection.prototype['_id'] = undefined;

/**
 * Name of the collection
 * @member {String} name
 */
ApiV1CollectionTasksTaskIdKillPost200ResponseCollection.prototype['name'] = undefined;

/**
 * Current state of the collection
 * @member {String} state
 */
ApiV1CollectionTasksTaskIdKillPost200ResponseCollection.prototype['state'] = undefined;
...
export default ApiV1CollectionTasksTaskIdKillPost200ResponseCollection;
