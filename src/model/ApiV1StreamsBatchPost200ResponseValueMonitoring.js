...
/**
 * The ApiV1StreamsBatchPost200ResponseValueMonitoring model module.
 * @module model/ApiV1StreamsBatchPost200ResponseValueMonitoring
 * @version 1.0.0
 */
class ApiV1StreamsBatchPost200ResponseValueMonitoring {
    /**
     * Constructs a new <code>ApiV1StreamsBatchPost200ResponseValueMonitoring</code>.
     * @alias module:model/ApiV1StreamsBatchPost200ResponseValueMonitoring
     */
    constructor() { 
        
        ApiV1StreamsBatchPost200ResponseValueMonitoring.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV1StreamsBatchPost200ResponseValueMonitoring</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV1StreamsBatchPost200ResponseValueMonitoring} obj Optional instance to populate.
     * @return {module:model/ApiV1StreamsBatchPost200ResponseValueMonitoring} The populated <code>ApiV1StreamsBatchPost200ResponseValueMonitoring</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV1StreamsBatchPost200ResponseValueMonitoring();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV1StreamsBatchPost200ResponseValueMonitoring</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV1StreamsBatchPost200ResponseValueMonitoring</code>.
     */
...
/**
 * Status of monitoring creation
 * @member {module:model/ApiV1StreamsBatchPost200ResponseValueMonitoring.StatusEnum} status
 */
ApiV1StreamsBatchPost200ResponseValueMonitoring.prototype['status'] = undefined;
 ...
 * @readonly
 */
ApiV1StreamsBatchPost200ResponseValueMonitoring['StatusEnum'] = {
...
export default ApiV1StreamsBatchPost200ResponseValueMonitoring;
