...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.OnPremApi();
  });
  ...
  describe('OnPremApi', function() {
    describe('apiV1SystemStatusGet', function() {
      it('should call apiV1SystemStatusGet successfully', function(done) {
        //uncomment below and update the code to test apiV1SystemStatusGet
        //instance.apiV1SystemStatusGet(function(error) {
