...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.UsersApi();
  });
  ...
  describe('UsersApi', function() {
    describe('apiV1TestUsersPost', function() {
      it('should call apiV1TestUsersPost successfully', function(done) {
        //uncomment below and update the code to test apiV1TestUsersPost
        //instance.apiV1TestUsersPost(function(error) {
    ...
    describe('apiV1TestUsersUserIdDelete', function() {
      it('should call apiV1TestUsersUserIdDelete successfully', function(done) {
        //uncomment below and update the code to test apiV1TestUsersUserIdDelete
        //instance.apiV1TestUsersUserIdDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
