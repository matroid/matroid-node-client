...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.DatasetApi();
  });
  ...
  describe('DatasetApi', function() {
    describe('apiV1DatasetDatasetIdMediaImMediaIdGet', function() {
      it('should call apiV1DatasetDatasetIdMediaImMediaIdGet successfully', function(done) {
        //uncomment below and update the code to test apiV1DatasetDatasetIdMediaImMediaIdGet
        //instance.apiV1DatasetDatasetIdMediaImMediaIdGet(function(error) {
    ...
    describe('apiV1DetectorsDetectorIdAddDataPost', function() {
      it('should call apiV1DetectorsDetectorIdAddDataPost successfully', function(done) {
        ...
        //instance.apiV1DetectorsDetectorIdAddDataPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
