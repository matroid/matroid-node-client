...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.AccountsApi();
  });
  ...
  describe('AccountsApi', function() {
    describe('apiV1AccountGet', function() {
      it('should call apiV1AccountGet successfully', function(done) {
        //uncomment below and update the code to test apiV1AccountGet
        //instance.apiV1AccountGet(function(error) {
    ...
    describe('apiV1OauthTokenPost', function() {
      it('should call apiV1OauthTokenPost successfully', function(done) {
        //uncomment below and update the code to test apiV1OauthTokenPost
        //instance.apiV1OauthTokenPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
