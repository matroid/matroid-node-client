...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.LabelsApi();
  });
  ...
  describe('LabelsApi', function() {
    describe('apiV1DetectorsDetectorIdLabelsLabelIdDelete', function() {
      it('should call apiV1DetectorsDetectorIdLabelsLabelIdDelete successfully', function(done) {
        //uncomment below and update the code to test apiV1DetectorsDetectorIdLabelsLabelIdDelete
        //instance.apiV1DetectorsDetectorIdLabelsLabelIdDelete(function(error) {
    ...
    describe('apiV1DetectorsDetectorIdLabelsLabelIdGet', function() {
      it('should call apiV1DetectorsDetectorIdLabelsLabelIdGet successfully', function(done) {
        //uncomment below and update the code to test apiV1DetectorsDetectorIdLabelsLabelIdGet
        //instance.apiV1DetectorsDetectorIdLabelsLabelIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV1DetectorsDetectorIdLabelsLabelIdPatch', function() {
      it('should call apiV1DetectorsDetectorIdLabelsLabelIdPatch successfully', function(done) {
        //uncomment below and update the code to test apiV1DetectorsDetectorIdLabelsLabelIdPatch
        //instance.apiV1DetectorsDetectorIdLabelsLabelIdPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV1DetectorsDetectorIdLabelsPost', function() {
      it('should call apiV1DetectorsDetectorIdLabelsPost successfully', function(done) {
        //uncomment below and update the code to test apiV1DetectorsDetectorIdLabelsPost
        //instance.apiV1DetectorsDetectorIdLabelsPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV1ImagesAnnotationsGet', function() {
      it('should call apiV1ImagesAnnotationsGet successfully', function(done) {
        //uncomment below and update the code to test apiV1ImagesAnnotationsGet
        //instance.apiV1ImagesAnnotationsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
