...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ImagesApi();
  });
  ...
  describe('ImagesApi', function() {
    describe('apiV1DetectorsDetectorIdClassifyImagePost', function() {
      it('should call apiV1DetectorsDetectorIdClassifyImagePost successfully', function(done) {
        //uncomment below and update the code to test apiV1DetectorsDetectorIdClassifyImagePost
        //instance.apiV1DetectorsDetectorIdClassifyImagePost(function(error) {
    ...
    describe('apiV1DetectorsDetectorIdGetSaliencyMapPost', function() {
      it('should call apiV1DetectorsDetectorIdGetSaliencyMapPost successfully', function(done) {
        //uncomment below and update the code to test apiV1DetectorsDetectorIdGetSaliencyMapPost
        //instance.apiV1DetectorsDetectorIdGetSaliencyMapPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('apiV1LocalizePost', function() {
      it('should call apiV1LocalizePost successfully', function(done) {
        //uncomment below and update the code to test apiV1LocalizePost
        //instance.apiV1LocalizePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
