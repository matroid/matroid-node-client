...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.BucketTasksApi();
  });
  ...
  describe('BucketTasksApi', function() {
    describe('apiV1BucketTasksPost', function() {
      it('should call apiV1BucketTasksPost successfully', function(done) {
        //uncomment below and update the code to test apiV1BucketTasksPost
        //instance.apiV1BucketTasksPost(function(error) {
    ...
    describe('apiV1BucketTasksTaskIdDownloadResultsGet', function() {
      it('should call apiV1BucketTasksTaskIdDownloadResultsGet successfully', function(done) {
        //uncomment below and update the code to test apiV1BucketTasksTaskIdDownloadResultsGet
        //instance.apiV1BucketTasksTaskIdDownloadResultsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
