...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.VideosApi();
  });
  ...
  describe('VideosApi', function() {
    describe('apiV1DetectorsDetectorIdClassifyVideoPost', function() {
      it('should call apiV1DetectorsDetectorIdClassifyVideoPost successfully', function(done) {
        //uncomment below and update the code to test apiV1DetectorsDetectorIdClassifyVideoPost
        //instance.apiV1DetectorsDetectorIdClassifyVideoPost(function(error) {
    ...
    describe('apiV1VideosVideoIdGet', function() {
      it('should call apiV1VideosVideoIdGet successfully', function(done) {
        //uncomment below and update the code to test apiV1VideosVideoIdGet
        //instance.apiV1VideosVideoIdGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
