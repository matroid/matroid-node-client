...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.LicensesApi();
  });
  ...
  describe('LicensesApi', function() {
    describe('apiV1LicensePost', function() {
      it('should call apiV1LicensePost successfully', function(done) {
        //uncomment below and update the code to test apiV1LicensePost
        //instance.apiV1LicensePost(function(error) {
