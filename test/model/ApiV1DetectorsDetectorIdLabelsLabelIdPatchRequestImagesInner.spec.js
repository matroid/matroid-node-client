...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequestImagesInner();
  });
  ...
  describe('ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequestImagesInner', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequestImagesInner', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequestImagesInner
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequestImagesInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequestImagesInner);
    });
