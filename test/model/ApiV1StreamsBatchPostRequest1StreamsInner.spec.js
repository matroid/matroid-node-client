...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsBatchPostRequest1StreamsInner();
  });
  ...
  describe('ApiV1StreamsBatchPostRequest1StreamsInner', function() {
    it('should create an instance of ApiV1StreamsBatchPostRequest1StreamsInner', function() {
      // uncomment below and update the code to test ApiV1StreamsBatchPostRequest1StreamsInner
      //var instance = new MatroidPublicApi.ApiV1StreamsBatchPostRequest1StreamsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsBatchPostRequest1StreamsInner);
    });
    ...
    it('should have the property daysOfVideoHistory (base name: "daysOfVideoHistory")', function() {
      // uncomment below and update the code to test the property daysOfVideoHistory
      //var instance = new MatroidPublicApi.ApiV1StreamsBatchPostRequest1StreamsInner();
      //expect(instance).to.be();
    });

    it('should have the property framesPerSecond (base name: "framesPerSecond")', function() {
      // uncomment below and update the code to test the property framesPerSecond
      //var instance = new MatroidPublicApi.ApiV1StreamsBatchPostRequest1StreamsInner();
      //expect(instance).to.be();
    });

    it('should have the property detectors (base name: "detectors")', function() {
      // uncomment below and update the code to test the property detectors
      //var instance = new MatroidPublicApi.ApiV1StreamsBatchPostRequest1StreamsInner();
      //expect(instance).to.be();
    });
