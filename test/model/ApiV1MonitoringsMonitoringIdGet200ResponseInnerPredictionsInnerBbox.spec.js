...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerBbox();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerBbox', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerBbox', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerBbox
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerBbox();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerBbox);
    });
