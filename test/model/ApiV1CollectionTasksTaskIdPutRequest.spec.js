...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdPutRequest();
  });
  ...
  describe('ApiV1CollectionTasksTaskIdPutRequest', function() {
    it('should create an instance of ApiV1CollectionTasksTaskIdPutRequest', function() {
      // uncomment below and update the code to test ApiV1CollectionTasksTaskIdPutRequest
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdPutRequest();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionTasksTaskIdPutRequest);
    });

    it('should have the property updateIndex (base name: "updateIndex")', function() {
      // uncomment below and update the code to test the property updateIndex
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdPutRequest();
