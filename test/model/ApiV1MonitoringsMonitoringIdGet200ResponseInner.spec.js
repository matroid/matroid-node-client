...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdGet200ResponseInner();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdGet200ResponseInner', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdGet200ResponseInner', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdGet200ResponseInner
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdGet200ResponseInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdGet200ResponseInner);
    });
