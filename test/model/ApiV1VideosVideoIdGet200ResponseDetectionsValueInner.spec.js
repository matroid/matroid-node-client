...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1VideosVideoIdGet200ResponseDetectionsValueInner();
  });
  ...
  describe('ApiV1VideosVideoIdGet200ResponseDetectionsValueInner', function() {
    it('should create an instance of ApiV1VideosVideoIdGet200ResponseDetectionsValueInner', function() {
      // uncomment below and update the code to test ApiV1VideosVideoIdGet200ResponseDetectionsValueInner
      //var instance = new MatroidPublicApi.ApiV1VideosVideoIdGet200ResponseDetectionsValueInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1VideosVideoIdGet200ResponseDetectionsValueInner);
    });
