...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPostRequestColors();
  });
  ...
  describe('ApiV1StreamsStreamIdMonitorDetectorIdPostRequestColors', function() {
    it('should create an instance of ApiV1StreamsStreamIdMonitorDetectorIdPostRequestColors', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdMonitorDetectorIdPostRequestColors
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPostRequestColors();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPostRequestColors);
    });
    ...
    it('should have the property darkColor (base name: "darkColor")', function() {
      // uncomment below and update the code to test the property darkColor
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPostRequestColors();
      //expect(instance).to.be();
    });
