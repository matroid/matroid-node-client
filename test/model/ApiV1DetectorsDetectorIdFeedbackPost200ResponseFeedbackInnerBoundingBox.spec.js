...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInnerBoundingBox();
  });
  ...
  describe('ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInnerBoundingBox', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInnerBoundingBox', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInnerBoundingBox
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInnerBoundingBox();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInnerBoundingBox);
    });
