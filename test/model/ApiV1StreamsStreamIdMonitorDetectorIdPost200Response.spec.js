...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPost200Response();
  });
  ...
  describe('ApiV1StreamsStreamIdMonitorDetectorIdPost200Response', function() {
    it('should create an instance of ApiV1StreamsStreamIdMonitorDetectorIdPost200Response', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdMonitorDetectorIdPost200Response
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPost200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPost200Response);
    });
    ...
    it('should have the property highFrequencyDetections (base name: "highFrequencyDetections")', function() {
      // uncomment below and update the code to test the property highFrequencyDetections
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPost200Response();
      //expect(instance).to.be();
    });
