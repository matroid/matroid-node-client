...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DatasetsDatasetIdLabelsPutRequestLabelUpdatesInner();
  });
  ...
  describe('ApiV1DatasetsDatasetIdLabelsPutRequestLabelUpdatesInner', function() {
    it('should create an instance of ApiV1DatasetsDatasetIdLabelsPutRequestLabelUpdatesInner', function() {
      // uncomment below and update the code to test ApiV1DatasetsDatasetIdLabelsPutRequestLabelUpdatesInner
      //var instance = new MatroidPublicApi.ApiV1DatasetsDatasetIdLabelsPutRequestLabelUpdatesInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DatasetsDatasetIdLabelsPutRequestLabelUpdatesInner);
    });
    ...
    it('should have the property updatedName (base name: "updatedName")', function() {
      // uncomment below and update the code to test the property updatedName
      //var instance = new MatroidPublicApi.ApiV1DatasetsDatasetIdLabelsPutRequestLabelUpdatesInner();
      //expect(instance).to.be();
    });
