...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsBatchPutRequestTaskUpdateDetection();
  });
  ...
  describe('ApiV1MonitoringsBatchPutRequestTaskUpdateDetection', function() {
    it('should create an instance of ApiV1MonitoringsBatchPutRequestTaskUpdateDetection', function() {
      // uncomment below and update the code to test ApiV1MonitoringsBatchPutRequestTaskUpdateDetection
      //var instance = new MatroidPublicApi.ApiV1MonitoringsBatchPutRequestTaskUpdateDetection();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsBatchPutRequestTaskUpdateDetection);
    });
