...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequestRegion();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdPutRequestRegion', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdPutRequestRegion', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdPutRequestRegion
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequestRegion();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequestRegion);
    });
