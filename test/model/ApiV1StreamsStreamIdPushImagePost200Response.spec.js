...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdPushImagePost200Response();
  });
  ...
  describe('ApiV1StreamsStreamIdPushImagePost200Response', function() {
    it('should create an instance of ApiV1StreamsStreamIdPushImagePost200Response', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdPushImagePost200Response
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdPushImagePost200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdPushImagePost200Response);
    });
