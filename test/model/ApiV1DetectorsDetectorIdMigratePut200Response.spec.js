...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdMigratePut200Response();
  });
  ...
  describe('ApiV1DetectorsDetectorIdMigratePut200Response', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdMigratePut200Response', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdMigratePut200Response
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdMigratePut200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdMigratePut200Response);
    });
