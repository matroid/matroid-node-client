...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequestSchedule();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdPutRequestSchedule', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdPutRequestSchedule', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdPutRequestSchedule
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequestSchedule();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequestSchedule);
    });
