...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1LocalizePost200ResponseResultsInnerPredictionsInner();
  });
  ...
  describe('ApiV1LocalizePost200ResponseResultsInnerPredictionsInner', function() {
    it('should create an instance of ApiV1LocalizePost200ResponseResultsInnerPredictionsInner', function() {
      // uncomment below and update the code to test ApiV1LocalizePost200ResponseResultsInnerPredictionsInner
      //var instance = new MatroidPublicApi.ApiV1LocalizePost200ResponseResultsInnerPredictionsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1LocalizePost200ResponseResultsInnerPredictionsInner);
    });
