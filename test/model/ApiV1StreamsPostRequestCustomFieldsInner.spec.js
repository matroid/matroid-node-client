...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsPostRequestCustomFieldsInner();
  });
  ...
  describe('ApiV1StreamsPostRequestCustomFieldsInner', function() {
    it('should create an instance of ApiV1StreamsPostRequestCustomFieldsInner', function() {
      // uncomment below and update the code to test ApiV1StreamsPostRequestCustomFieldsInner
      //var instance = new MatroidPublicApi.ApiV1StreamsPostRequestCustomFieldsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsPostRequestCustomFieldsInner);
    });
