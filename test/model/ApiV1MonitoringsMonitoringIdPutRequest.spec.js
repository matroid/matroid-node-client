...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequest();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdPutRequest', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdPutRequest', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdPutRequest
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequest();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequest);
    });
    ...
    it('should have the property keepEndTime (base name: "keepEndTime")', function() {
      // uncomment below and update the code to test the property keepEndTime
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property registeredEndpoint (base name: "registeredEndpoint")', function() {
      // uncomment below and update the code to test the property registeredEndpoint
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequest();
      //expect(instance).to.be();
    });

    it('should have the property rawEndpointMessage (base name: "rawEndpointMessage")', function() {
      // uncomment below and update the code to test the property rawEndpointMessage
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property groupsWithViewAccess (base name: "groupsWithViewAccess")', function() {
      // uncomment below and update the code to test the property groupsWithViewAccess
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequest();
      //expect(instance).to.be();
    });
