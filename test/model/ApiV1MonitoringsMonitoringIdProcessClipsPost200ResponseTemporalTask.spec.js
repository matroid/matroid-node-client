...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdProcessClipsPost200ResponseTemporalTask);
    });
