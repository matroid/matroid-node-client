...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInner();
  });
  ...
  describe('ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInner', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInner', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInner
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInner);
    });
