...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner();
  });
  ...
  describe('ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner', function() {
    it('should create an instance of ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner', function() {
      // uncomment below and update the code to test ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner
      //var instance = new MatroidPublicApi.ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsBatchPostRequest1StreamsInnerCustomFieldsInner);
    });
