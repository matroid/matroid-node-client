...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackGet200ResponseInnerOneOf();
  });
  ...
  describe('ApiV1DetectorsDetectorIdFeedbackGet200ResponseInnerOneOf', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdFeedbackGet200ResponseInnerOneOf', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdFeedbackGet200ResponseInnerOneOf
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackGet200ResponseInnerOneOf();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackGet200ResponseInnerOneOf);
    });
