...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdScoresQueryPostRequest();
  });
  ...
  describe('ApiV1CollectionTasksTaskIdScoresQueryPostRequest', function() {
    it('should create an instance of ApiV1CollectionTasksTaskIdScoresQueryPostRequest', function() {
      // uncomment below and update the code to test ApiV1CollectionTasksTaskIdScoresQueryPostRequest
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdScoresQueryPostRequest();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionTasksTaskIdScoresQueryPostRequest);
    });
