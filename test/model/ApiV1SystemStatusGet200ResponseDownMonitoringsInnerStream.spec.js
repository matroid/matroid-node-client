...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream();
  });
  ...
  describe('ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream', function() {
    it('should create an instance of ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream', function() {
      // uncomment below and update the code to test ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream
      //var instance = new MatroidPublicApi.ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1SystemStatusGet200ResponseDownMonitoringsInnerStream);
    });
