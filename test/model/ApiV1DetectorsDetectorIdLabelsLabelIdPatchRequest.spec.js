...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequest();
  });
  ...
  describe('ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequest', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequest', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequest
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequest();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequest);
    });
