...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsBatchPostRequest1();
  });
  ...
  describe('ApiV1StreamsBatchPostRequest1', function() {
    it('should create an instance of ApiV1StreamsBatchPostRequest1', function() {
      // uncomment below and update the code to test ApiV1StreamsBatchPostRequest1
      //var instance = new MatroidPublicApi.ApiV1StreamsBatchPostRequest1();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsBatchPostRequest1);
    });

    it('should have the property monitorSettings (base name: "monitorSettings")', function() {
      // uncomment below and update the code to test the property monitorSettings
      //var instance = new MatroidPublicApi.ApiV1StreamsBatchPostRequest1();
