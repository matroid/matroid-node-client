...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdClassifyVideoPost200Response();
  });
  ...
  describe('ApiV1DetectorsDetectorIdClassifyVideoPost200Response', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdClassifyVideoPost200Response', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdClassifyVideoPost200Response
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdClassifyVideoPost200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdClassifyVideoPost200Response);
    });
