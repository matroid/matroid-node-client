...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackGet200ResponseInner();
  });
  ...
  describe('ApiV1DetectorsDetectorIdFeedbackGet200ResponseInner', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdFeedbackGet200ResponseInner', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdFeedbackGet200ResponseInner
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackGet200ResponseInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackGet200ResponseInner);
    });
