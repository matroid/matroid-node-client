...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdTemporalTaskPost200Response();
  });
  ...
  describe('ApiV1StreamsStreamIdTemporalTaskPost200Response', function() {
    it('should create an instance of ApiV1StreamsStreamIdTemporalTaskPost200Response', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdTemporalTaskPost200Response
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdTemporalTaskPost200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdTemporalTaskPost200Response);
    });
