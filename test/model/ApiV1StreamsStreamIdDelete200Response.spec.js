...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdDelete200Response();
  });
  ...
  describe('ApiV1StreamsStreamIdDelete200Response', function() {
    it('should create an instance of ApiV1StreamsStreamIdDelete200Response', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdDelete200Response
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdDelete200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdDelete200Response);
    });
