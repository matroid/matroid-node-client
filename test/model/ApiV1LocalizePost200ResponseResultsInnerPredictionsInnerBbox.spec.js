...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1LocalizePost200ResponseResultsInnerPredictionsInnerBbox();
  });
  ...
  describe('ApiV1LocalizePost200ResponseResultsInnerPredictionsInnerBbox', function() {
    it('should create an instance of ApiV1LocalizePost200ResponseResultsInnerPredictionsInnerBbox', function() {
      // uncomment below and update the code to test ApiV1LocalizePost200ResponseResultsInnerPredictionsInnerBbox
      //var instance = new MatroidPublicApi.ApiV1LocalizePost200ResponseResultsInnerPredictionsInnerBbox();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1LocalizePost200ResponseResultsInnerPredictionsInnerBbox);
    });
