...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1SystemStatusGet200ResponseDownMonitoringsInner();
  });
  ...
  describe('ApiV1SystemStatusGet200ResponseDownMonitoringsInner', function() {
    it('should create an instance of ApiV1SystemStatusGet200ResponseDownMonitoringsInner', function() {
      // uncomment below and update the code to test ApiV1SystemStatusGet200ResponseDownMonitoringsInner
      //var instance = new MatroidPublicApi.ApiV1SystemStatusGet200ResponseDownMonitoringsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1SystemStatusGet200ResponseDownMonitoringsInner);
    });
