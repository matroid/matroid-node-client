...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdImageQueryPostRequestBoundingBox();
  });
  ...
  describe('ApiV1CollectionTasksTaskIdImageQueryPostRequestBoundingBox', function() {
    it('should create an instance of ApiV1CollectionTasksTaskIdImageQueryPostRequestBoundingBox', function() {
      // uncomment below and update the code to test ApiV1CollectionTasksTaskIdImageQueryPostRequestBoundingBox
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdImageQueryPostRequestBoundingBox();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionTasksTaskIdImageQueryPostRequestBoundingBox);
    });
