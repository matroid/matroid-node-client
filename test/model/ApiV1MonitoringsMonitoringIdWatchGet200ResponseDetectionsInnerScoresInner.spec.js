...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInnerScoresInner();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInnerScoresInner', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInnerScoresInner', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInnerScoresInner
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInnerScoresInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInnerScoresInner);
    });
