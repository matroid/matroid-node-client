...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionsCollectionIdDelete200Response();
  });
  ...
  describe('ApiV1CollectionsCollectionIdDelete200Response', function() {
    it('should create an instance of ApiV1CollectionsCollectionIdDelete200Response', function() {
      // uncomment below and update the code to test ApiV1CollectionsCollectionIdDelete200Response
      //var instance = new MatroidPublicApi.ApiV1CollectionsCollectionIdDelete200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionsCollectionIdDelete200Response);
    });
