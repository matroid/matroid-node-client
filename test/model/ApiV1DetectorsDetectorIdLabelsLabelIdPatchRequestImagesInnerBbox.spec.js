...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequestImagesInnerBbox();
  });
  ...
  describe('ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequestImagesInnerBbox', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequestImagesInnerBbox', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequestImagesInnerBbox
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequestImagesInnerBbox();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdPatchRequestImagesInnerBbox);
    });
