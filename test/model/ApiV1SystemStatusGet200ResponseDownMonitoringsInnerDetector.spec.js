...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1SystemStatusGet200ResponseDownMonitoringsInnerDetector();
  });
  ...
  describe('ApiV1SystemStatusGet200ResponseDownMonitoringsInnerDetector', function() {
    it('should create an instance of ApiV1SystemStatusGet200ResponseDownMonitoringsInnerDetector', function() {
      // uncomment below and update the code to test ApiV1SystemStatusGet200ResponseDownMonitoringsInnerDetector
      //var instance = new MatroidPublicApi.ApiV1SystemStatusGet200ResponseDownMonitoringsInnerDetector();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1SystemStatusGet200ResponseDownMonitoringsInnerDetector);
    });
    ...
    it('should have the property humanName (base name: "humanName")', function() {
      // uncomment below and update the code to test the property humanName
      //var instance = new MatroidPublicApi.ApiV1SystemStatusGet200ResponseDownMonitoringsInnerDetector();
      //expect(instance).to.be();
    });
