...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdGetSaliencyMapPost200Response();
  });
  ...
  describe('ApiV1DetectorsDetectorIdGetSaliencyMapPost200Response', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdGetSaliencyMapPost200Response', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdGetSaliencyMapPost200Response
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdGetSaliencyMapPost200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdGetSaliencyMapPost200Response);
    });

    it('should have the property saliencyMapUrl (base name: "saliency_map_url")', function() {
      // uncomment below and update the code to test the property saliencyMapUrl
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdGetSaliencyMapPost200Response();
