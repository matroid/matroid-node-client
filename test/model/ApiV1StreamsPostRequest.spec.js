...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsPostRequest();
  });
  ...
  describe('ApiV1StreamsPostRequest', function() {
    it('should create an instance of ApiV1StreamsPostRequest', function() {
      // uncomment below and update the code to test ApiV1StreamsPostRequest
      //var instance = new MatroidPublicApi.ApiV1StreamsPostRequest();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsPostRequest);
    });
