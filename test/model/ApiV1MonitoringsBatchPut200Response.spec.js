...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsBatchPut200Response();
  });
  ...
  describe('ApiV1MonitoringsBatchPut200Response', function() {
    it('should create an instance of ApiV1MonitoringsBatchPut200Response', function() {
      // uncomment below and update the code to test ApiV1MonitoringsBatchPut200Response
      //var instance = new MatroidPublicApi.ApiV1MonitoringsBatchPut200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsBatchPut200Response);
    });

    it('should have the property modifiedMonitorings (base name: "modifiedMonitorings")', function() {
      // uncomment below and update the code to test the property modifiedMonitorings
      //var instance = new MatroidPublicApi.ApiV1MonitoringsBatchPut200Response();
