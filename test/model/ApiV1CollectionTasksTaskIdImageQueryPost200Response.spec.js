...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdImageQueryPost200Response();
  });
  ...
  describe('ApiV1CollectionTasksTaskIdImageQueryPost200Response', function() {
    it('should create an instance of ApiV1CollectionTasksTaskIdImageQueryPost200Response', function() {
      // uncomment below and update the code to test ApiV1CollectionTasksTaskIdImageQueryPost200Response
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdImageQueryPost200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionTasksTaskIdImageQueryPost200Response);
    });
