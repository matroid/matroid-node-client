...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1AccountGet200ResponseAccountName();
  });
  ...
  describe('ApiV1AccountGet200ResponseAccountName', function() {
    it('should create an instance of ApiV1AccountGet200ResponseAccountName', function() {
      // uncomment below and update the code to test ApiV1AccountGet200ResponseAccountName
      //var instance = new MatroidPublicApi.ApiV1AccountGet200ResponseAccountName();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1AccountGet200ResponseAccountName);
    });
