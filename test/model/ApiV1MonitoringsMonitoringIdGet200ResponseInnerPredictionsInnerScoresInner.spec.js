...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInnerScoresInner);
    });
