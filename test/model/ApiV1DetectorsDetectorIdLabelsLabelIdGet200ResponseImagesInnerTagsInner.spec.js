...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInnerTagsInner();
  });
  ...
  describe('ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInnerTagsInner', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInnerTagsInner', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInnerTagsInner
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInnerTagsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInnerTagsInner);
    });
