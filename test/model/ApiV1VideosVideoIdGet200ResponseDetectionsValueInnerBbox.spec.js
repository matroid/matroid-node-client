...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox();
  });
  ...
  describe('ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox', function() {
    it('should create an instance of ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox', function() {
      // uncomment below and update the code to test ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox
      //var instance = new MatroidPublicApi.ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1VideosVideoIdGet200ResponseDetectionsValueInnerBbox);
    });
