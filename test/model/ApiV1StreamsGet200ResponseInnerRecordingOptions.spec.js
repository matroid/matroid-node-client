...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsGet200ResponseInnerRecordingOptions();
  });
  ...
  describe('ApiV1StreamsGet200ResponseInnerRecordingOptions', function() {
    it('should create an instance of ApiV1StreamsGet200ResponseInnerRecordingOptions', function() {
      // uncomment below and update the code to test ApiV1StreamsGet200ResponseInnerRecordingOptions
      //var instance = new MatroidPublicApi.ApiV1StreamsGet200ResponseInnerRecordingOptions();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsGet200ResponseInnerRecordingOptions);
    });
