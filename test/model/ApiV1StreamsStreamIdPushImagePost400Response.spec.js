...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdPushImagePost400Response();
  });
  ...
  describe('ApiV1StreamsStreamIdPushImagePost400Response', function() {
    it('should create an instance of ApiV1StreamsStreamIdPushImagePost400Response', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdPushImagePost400Response
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdPushImagePost400Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdPushImagePost400Response);
    });
