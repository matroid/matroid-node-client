...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsGet200ResponseInner();
  });
  ...
  describe('ApiV1DetectorsGet200ResponseInner', function() {
    it('should create an instance of ApiV1DetectorsGet200ResponseInner', function() {
      // uncomment below and update the code to test ApiV1DetectorsGet200ResponseInner
      //var instance = new MatroidPublicApi.ApiV1DetectorsGet200ResponseInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsGet200ResponseInner);
    });

    it('should have the property detectorId (base name: "detector_id")', function() {
      // uncomment below and update the code to test the property detectorId
      //var instance = new MatroidPublicApi.ApiV1DetectorsGet200ResponseInner();
      //expect(instance).to.be();
    });

    it('should have the property humanName (base name: "human_name")', function() {
    ...
    it('should have the property permissionLevel (base name: "permission_level")', function() {
