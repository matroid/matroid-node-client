...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPut200ResponseColors();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdPut200ResponseColors', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdPut200ResponseColors', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdPut200ResponseColors
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPut200ResponseColors();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdPut200ResponseColors);
    });
