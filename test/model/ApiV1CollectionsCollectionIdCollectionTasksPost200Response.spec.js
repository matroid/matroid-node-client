...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionsCollectionIdCollectionTasksPost200Response();
  });
  ...
  describe('ApiV1CollectionsCollectionIdCollectionTasksPost200Response', function() {
    it('should create an instance of ApiV1CollectionsCollectionIdCollectionTasksPost200Response', function() {
      // uncomment below and update the code to test ApiV1CollectionsCollectionIdCollectionTasksPost200Response
      //var instance = new MatroidPublicApi.ApiV1CollectionsCollectionIdCollectionTasksPost200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionsCollectionIdCollectionTasksPost200Response);
    });
