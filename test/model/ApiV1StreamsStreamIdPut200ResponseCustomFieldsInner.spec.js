...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner();
  });
  ...
  describe('ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner', function() {
    it('should create an instance of ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdPut200ResponseCustomFieldsInner);
    });
