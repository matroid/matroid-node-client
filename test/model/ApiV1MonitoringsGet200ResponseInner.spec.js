...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsGet200ResponseInner();
  });
  ...
  describe('ApiV1MonitoringsGet200ResponseInner', function() {
    it('should create an instance of ApiV1MonitoringsGet200ResponseInner', function() {
      // uncomment below and update the code to test ApiV1MonitoringsGet200ResponseInner
      //var instance = new MatroidPublicApi.ApiV1MonitoringsGet200ResponseInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsGet200ResponseInner);
    });
    ...
    it('should have the property lastDetectAt (base name: "lastDetectAt")', function() {
      // uncomment below and update the code to test the property lastDetectAt
      //var instance = new MatroidPublicApi.ApiV1MonitoringsGet200ResponseInner();
      //expect(instance).to.be();
    });
