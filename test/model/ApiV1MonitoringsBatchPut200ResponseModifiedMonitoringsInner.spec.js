...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner();
  });
  ...
  describe('ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner', function() {
    it('should create an instance of ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner', function() {
      // uncomment below and update the code to test ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner
      //var instance = new MatroidPublicApi.ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsBatchPut200ResponseModifiedMonitoringsInner);
    });
