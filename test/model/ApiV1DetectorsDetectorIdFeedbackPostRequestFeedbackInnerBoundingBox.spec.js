...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackPostRequestFeedbackInnerBoundingBox();
  });
  ...
  describe('ApiV1DetectorsDetectorIdFeedbackPostRequestFeedbackInnerBoundingBox', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdFeedbackPostRequestFeedbackInnerBoundingBox', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdFeedbackPostRequestFeedbackInnerBoundingBox
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackPostRequestFeedbackInnerBoundingBox();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackPostRequestFeedbackInnerBoundingBox);
    });
