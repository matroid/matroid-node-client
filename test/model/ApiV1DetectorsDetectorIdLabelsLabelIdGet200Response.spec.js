...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response();
  });
  ...
  describe('ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdGet200Response);
    });
