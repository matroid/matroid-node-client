...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInner();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInner', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInner', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInner
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInner);
    });
