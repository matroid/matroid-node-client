...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdTemporalTasksGet200Response();
  });
  ...
  describe('ApiV1StreamsStreamIdTemporalTasksGet200Response', function() {
    it('should create an instance of ApiV1StreamsStreamIdTemporalTasksGet200Response', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdTemporalTasksGet200Response
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdTemporalTasksGet200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdTemporalTasksGet200Response);
    });

    it('should have the property temporalTasks (base name: "temporal_tasks")', function() {
      // uncomment below and update the code to test the property temporalTasks
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdTemporalTasksGet200Response();
