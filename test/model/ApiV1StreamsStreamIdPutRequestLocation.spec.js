...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdPutRequestLocation();
  });
  ...
  describe('ApiV1StreamsStreamIdPutRequestLocation', function() {
    it('should create an instance of ApiV1StreamsStreamIdPutRequestLocation', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdPutRequestLocation
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdPutRequestLocation();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdPutRequestLocation);
    });
