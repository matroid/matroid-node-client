...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsBatchPutRequest();
  });
  ...
  describe('ApiV1MonitoringsBatchPutRequest', function() {
    it('should create an instance of ApiV1MonitoringsBatchPutRequest', function() {
      // uncomment below and update the code to test ApiV1MonitoringsBatchPutRequest
      //var instance = new MatroidPublicApi.ApiV1MonitoringsBatchPutRequest();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsBatchPutRequest);
    });

    it('should have the property monitoringIds (base name: "monitoringIds")', function() {
      // uncomment below and update the code to test the property monitoringIds
      //var instance = new MatroidPublicApi.ApiV1MonitoringsBatchPutRequest();
      //expect(instance).to.be();
    });

    it('should have the property taskUpdate (base name: "taskUpdate")', function() {
      // uncomment below and update the code to test the property taskUpdate
      //var instance = new MatroidPublicApi.ApiV1MonitoringsBatchPutRequest();
      //expect(instance).to.be();
    });
