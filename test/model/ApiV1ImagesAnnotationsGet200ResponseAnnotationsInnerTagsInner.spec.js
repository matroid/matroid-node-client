...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1ImagesAnnotationsGet200ResponseAnnotationsInnerTagsInner();
  });
  ...
  describe('ApiV1ImagesAnnotationsGet200ResponseAnnotationsInnerTagsInner', function() {
    it('should create an instance of ApiV1ImagesAnnotationsGet200ResponseAnnotationsInnerTagsInner', function() {
      // uncomment below and update the code to test ApiV1ImagesAnnotationsGet200ResponseAnnotationsInnerTagsInner
      //var instance = new MatroidPublicApi.ApiV1ImagesAnnotationsGet200ResponseAnnotationsInnerTagsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1ImagesAnnotationsGet200ResponseAnnotationsInnerTagsInner);
    });
    ...
    it('should have the property segmentation (base name: "segmentation")', function() {
      // uncomment below and update the code to test the property segmentation
      //var instance = new MatroidPublicApi.ApiV1ImagesAnnotationsGet200ResponseAnnotationsInnerTagsInner();
      //expect(instance).to.be();
    });
