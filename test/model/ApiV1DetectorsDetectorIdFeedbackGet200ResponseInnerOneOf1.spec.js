...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackGet200ResponseInnerOneOf1();
  });
  ...
  describe('ApiV1DetectorsDetectorIdFeedbackGet200ResponseInnerOneOf1', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdFeedbackGet200ResponseInnerOneOf1', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdFeedbackGet200ResponseInnerOneOf1
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackGet200ResponseInnerOneOf1();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackGet200ResponseInnerOneOf1);
    });
