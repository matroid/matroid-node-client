...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdGet200ResponseCollectionTask();
  });
  ...
  describe('ApiV1CollectionTasksTaskIdGet200ResponseCollectionTask', function() {
    it('should create an instance of ApiV1CollectionTasksTaskIdGet200ResponseCollectionTask', function() {
      // uncomment below and update the code to test ApiV1CollectionTasksTaskIdGet200ResponseCollectionTask
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdGet200ResponseCollectionTask();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionTasksTaskIdGet200ResponseCollectionTask);
    });
