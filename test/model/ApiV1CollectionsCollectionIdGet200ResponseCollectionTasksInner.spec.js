...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner();
  });
  ...
  describe('ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner', function() {
    it('should create an instance of ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner', function() {
      // uncomment below and update the code to test ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner
      //var instance = new MatroidPublicApi.ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionsCollectionIdGet200ResponseCollectionTasksInner);
    });
