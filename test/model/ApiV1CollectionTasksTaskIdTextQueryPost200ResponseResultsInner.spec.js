...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdTextQueryPost200ResponseResultsInner();
  });
  ...
  describe('ApiV1CollectionTasksTaskIdTextQueryPost200ResponseResultsInner', function() {
    it('should create an instance of ApiV1CollectionTasksTaskIdTextQueryPost200ResponseResultsInner', function() {
      // uncomment below and update the code to test ApiV1CollectionTasksTaskIdTextQueryPost200ResponseResultsInner
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdTextQueryPost200ResponseResultsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionTasksTaskIdTextQueryPost200ResponseResultsInner);
    });
    ...
    it('should have the property bboxesNested (base name: "bboxes_nested")', function() {
      // uncomment below and update the code to test the property bboxesNested
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdTextQueryPost200ResponseResultsInner();
      //expect(instance).to.be();
    });

    it('should have the property boxNum (base name: "box_num")', function() {
      // uncomment below and update the code to test the property boxNum
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdTextQueryPost200ResponseResultsInner();
      //expect(instance).to.be();
    });
