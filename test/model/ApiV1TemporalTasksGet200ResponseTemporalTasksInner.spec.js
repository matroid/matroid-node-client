...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1TemporalTasksGet200ResponseTemporalTasksInner();
  });
  ...
  describe('ApiV1TemporalTasksGet200ResponseTemporalTasksInner', function() {
    it('should create an instance of ApiV1TemporalTasksGet200ResponseTemporalTasksInner', function() {
      // uncomment below and update the code to test ApiV1TemporalTasksGet200ResponseTemporalTasksInner
      //var instance = new MatroidPublicApi.ApiV1TemporalTasksGet200ResponseTemporalTasksInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1TemporalTasksGet200ResponseTemporalTasksInner);
    });
