...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInnerBbox();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInnerBbox', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInnerBbox', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInnerBbox
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInnerBbox();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200ResponseDetectionsInnerBbox);
    });
