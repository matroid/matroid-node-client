...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner();
  });
  ...
  describe('ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner', function() {
    it('should create an instance of ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner', function() {
      // uncomment below and update the code to test ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner
      //var instance = new MatroidPublicApi.ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1ImagesAnnotationsGet200ResponseAnnotationsInner);
    });
