...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner();
  });
  ...
  describe('ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner', function() {
    it('should create an instance of ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdSummariesGet200ResponseSummariesInner);
    });
