...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackFeedbackIdDelete200Response();
  });
  ...
  describe('ApiV1DetectorsDetectorIdFeedbackFeedbackIdDelete200Response', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdFeedbackFeedbackIdDelete200Response', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdFeedbackFeedbackIdDelete200Response
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackFeedbackIdDelete200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackFeedbackIdDelete200Response);
    });
