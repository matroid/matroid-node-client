...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionsCollectionIdGet200ResponseCollection();
  });
  ...
  describe('ApiV1CollectionsCollectionIdGet200ResponseCollection', function() {
    it('should create an instance of ApiV1CollectionsCollectionIdGet200ResponseCollection', function() {
      // uncomment below and update the code to test ApiV1CollectionsCollectionIdGet200ResponseCollection
      //var instance = new MatroidPublicApi.ApiV1CollectionsCollectionIdGet200ResponseCollection();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionsCollectionIdGet200ResponseCollection);
    });
