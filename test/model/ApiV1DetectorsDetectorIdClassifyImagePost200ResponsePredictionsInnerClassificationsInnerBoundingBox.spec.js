...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInnerClassificationsInnerBoundingBox();
  });
  ...
  describe('ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInnerClassificationsInnerBoundingBox', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInnerClassificationsInnerBoundingBox', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInnerClassificationsInnerBoundingBox
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInnerClassificationsInnerBoundingBox();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdClassifyImagePost200ResponsePredictionsInnerClassificationsInnerBoundingBox);
    });
