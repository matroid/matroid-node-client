...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200Response();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdWatchGet200Response', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdWatchGet200Response', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdWatchGet200Response
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200Response);
    });

    it('should have the property detectedAt (base name: "detectedAt")', function() {
      // uncomment below and update the code to test the property detectedAt
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200Response();
    ...
    it('should have the property monitoringId (base name: "monitoringId")', function() {
      // uncomment below and update the code to test the property monitoringId
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200Response();
      //expect(instance).to.be();
    });
    ...
    it('should have the property screenshotUrl (base name: "screenshotUrl")', function() {
      // uncomment below and update the code to test the property screenshotUrl
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200Response();
      //expect(instance).to.be();
    });

    it('should have the property labelColors (base name: "labelColors")', function() {
      // uncomment below and update the code to test the property labelColors
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdWatchGet200Response();
      //expect(instance).to.be();
    });
    ...
    it('should have the property recordingUrl (base name: "recordingUrl")', function() {
