...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DatasetsDatasetIdLabelsPutRequest();
  });
  ...
  describe('ApiV1DatasetsDatasetIdLabelsPutRequest', function() {
    it('should create an instance of ApiV1DatasetsDatasetIdLabelsPutRequest', function() {
      // uncomment below and update the code to test ApiV1DatasetsDatasetIdLabelsPutRequest
      //var instance = new MatroidPublicApi.ApiV1DatasetsDatasetIdLabelsPutRequest();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DatasetsDatasetIdLabelsPutRequest);
    });

    it('should have the property labelUpdates (base name: "labelUpdates")', function() {
      // uncomment below and update the code to test the property labelUpdates
      //var instance = new MatroidPublicApi.ApiV1DatasetsDatasetIdLabelsPutRequest();
