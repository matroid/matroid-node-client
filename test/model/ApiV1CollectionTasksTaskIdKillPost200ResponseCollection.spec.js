...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdKillPost200ResponseCollection();
  });
  ...
  describe('ApiV1CollectionTasksTaskIdKillPost200ResponseCollection', function() {
    it('should create an instance of ApiV1CollectionTasksTaskIdKillPost200ResponseCollection', function() {
      // uncomment below and update the code to test ApiV1CollectionTasksTaskIdKillPost200ResponseCollection
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdKillPost200ResponseCollection();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionTasksTaskIdKillPost200ResponseCollection);
    });
