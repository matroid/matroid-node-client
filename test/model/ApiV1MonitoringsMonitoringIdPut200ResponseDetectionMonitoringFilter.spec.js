...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPut200ResponseDetectionMonitoringFilter();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdPut200ResponseDetectionMonitoringFilter', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdPut200ResponseDetectionMonitoringFilter', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdPut200ResponseDetectionMonitoringFilter
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPut200ResponseDetectionMonitoringFilter();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdPut200ResponseDetectionMonitoringFilter);
    });
