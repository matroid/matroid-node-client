...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1LocalizePost200ResponseResultsInnerFileInner();
  });
  ...
  describe('ApiV1LocalizePost200ResponseResultsInnerFileInner', function() {
    it('should create an instance of ApiV1LocalizePost200ResponseResultsInnerFileInner', function() {
      // uncomment below and update the code to test ApiV1LocalizePost200ResponseResultsInnerFileInner
      //var instance = new MatroidPublicApi.ApiV1LocalizePost200ResponseResultsInnerFileInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1LocalizePost200ResponseResultsInnerFileInner);
    });
