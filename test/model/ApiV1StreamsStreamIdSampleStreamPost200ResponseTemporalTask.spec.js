...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdSampleStreamPost200ResponseTemporalTask();
  });
  ...
  describe('ApiV1StreamsStreamIdSampleStreamPost200ResponseTemporalTask', function() {
    it('should create an instance of ApiV1StreamsStreamIdSampleStreamPost200ResponseTemporalTask', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdSampleStreamPost200ResponseTemporalTask
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdSampleStreamPost200ResponseTemporalTask();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdSampleStreamPost200ResponseTemporalTask);
    });
