...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsGet200ResponseInner();
  });
  ...
  describe('ApiV1StreamsGet200ResponseInner', function() {
    it('should create an instance of ApiV1StreamsGet200ResponseInner', function() {
      // uncomment below and update the code to test ApiV1StreamsGet200ResponseInner
      //var instance = new MatroidPublicApi.ApiV1StreamsGet200ResponseInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsGet200ResponseInner);
    });
    ...
    it('should have the property detectionFps (base name: "detectionFps")', function() {
      // uncomment below and update the code to test the property detectionFps
      //var instance = new MatroidPublicApi.ApiV1StreamsGet200ResponseInner();
      //expect(instance).to.be();
    });

    it('should have the property monitorings (base name: "monitorings")', function() {
      // uncomment below and update the code to test the property monitorings
      //var instance = new MatroidPublicApi.ApiV1StreamsGet200ResponseInner();
      //expect(instance).to.be();
    });

    it('should have the property recordingOptions (base name: "recordingOptions")', function() {
      // uncomment below and update the code to test the property recordingOptions
      //var instance = new MatroidPublicApi.ApiV1StreamsGet200ResponseInner();
      //expect(instance).to.be();
    });

    it('should have the property recordingStartTime (base name: "recordingStartTime")', function() {
      // uncomment below and update the code to test the property recordingStartTime
      //var instance = new MatroidPublicApi.ApiV1StreamsGet200ResponseInner();
      //expect(instance).to.be();
    });
