...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdDelete200Response();
  });
  ...
  describe('ApiV1DetectorsDetectorIdLabelsLabelIdDelete200Response', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdLabelsLabelIdDelete200Response', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdLabelsLabelIdDelete200Response
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdDelete200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdDelete200Response);
    });
