...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1LocalizePost200ResponseResultsInner();
  });
  ...
  describe('ApiV1LocalizePost200ResponseResultsInner', function() {
    it('should create an instance of ApiV1LocalizePost200ResponseResultsInner', function() {
      // uncomment below and update the code to test ApiV1LocalizePost200ResponseResultsInner
      //var instance = new MatroidPublicApi.ApiV1LocalizePost200ResponseResultsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1LocalizePost200ResponseResultsInner);
    });
