...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdDelete200Response();
  });
  ...
  describe('ApiV1CollectionTasksTaskIdDelete200Response', function() {
    it('should create an instance of ApiV1CollectionTasksTaskIdDelete200Response', function() {
      // uncomment below and update the code to test ApiV1CollectionTasksTaskIdDelete200Response
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdDelete200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionTasksTaskIdDelete200Response);
    });

    it('should have the property collectionTask (base name: "collectionTask")', function() {
      // uncomment below and update the code to test the property collectionTask
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdDelete200Response();
