...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdScoresQueryPost200ResponseResultsInner();
  });
  ...
  describe('ApiV1CollectionTasksTaskIdScoresQueryPost200ResponseResultsInner', function() {
    it('should create an instance of ApiV1CollectionTasksTaskIdScoresQueryPost200ResponseResultsInner', function() {
      // uncomment below and update the code to test ApiV1CollectionTasksTaskIdScoresQueryPost200ResponseResultsInner
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdScoresQueryPost200ResponseResultsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionTasksTaskIdScoresQueryPost200ResponseResultsInner);
    });
    ...
    it('should have the property faissId (base name: "faissId")', function() {
      // uncomment below and update the code to test the property faissId
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdScoresQueryPost200ResponseResultsInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property boundingBoxes (base name: "boundingBoxes")', function() {
