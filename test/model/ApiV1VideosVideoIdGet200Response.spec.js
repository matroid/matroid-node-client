...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1VideosVideoIdGet200Response();
  });
  ...
  describe('ApiV1VideosVideoIdGet200Response', function() {
    it('should create an instance of ApiV1VideosVideoIdGet200Response', function() {
      // uncomment below and update the code to test ApiV1VideosVideoIdGet200Response
      //var instance = new MatroidPublicApi.ApiV1VideosVideoIdGet200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1VideosVideoIdGet200Response);
    });
    ...
    it('should have the property classificationProgress (base name: "classificationProgress")', function() {
      // uncomment below and update the code to test the property classificationProgress
      //var instance = new MatroidPublicApi.ApiV1VideosVideoIdGet200Response();
      //expect(instance).to.be();
    });
    ...
    it('should have the property labelDict (base name: "labelDict")', function() {
      // uncomment below and update the code to test the property labelDict
      //var instance = new MatroidPublicApi.ApiV1VideosVideoIdGet200Response();
      //expect(instance).to.be();
    });
