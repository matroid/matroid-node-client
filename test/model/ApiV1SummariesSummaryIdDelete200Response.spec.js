...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1SummariesSummaryIdDelete200Response();
  });
  ...
  describe('ApiV1SummariesSummaryIdDelete200Response', function() {
    it('should create an instance of ApiV1SummariesSummaryIdDelete200Response', function() {
      // uncomment below and update the code to test ApiV1SummariesSummaryIdDelete200Response
      //var instance = new MatroidPublicApi.ApiV1SummariesSummaryIdDelete200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1SummariesSummaryIdDelete200Response);
    });

    it('should have the property summaryId (base name: "summaryId")', function() {
      // uncomment below and update the code to test the property summaryId
      //var instance = new MatroidPublicApi.ApiV1SummariesSummaryIdDelete200Response();
