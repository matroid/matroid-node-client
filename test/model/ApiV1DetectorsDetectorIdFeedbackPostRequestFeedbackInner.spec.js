...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackPostRequestFeedbackInner();
  });
  ...
  describe('ApiV1DetectorsDetectorIdFeedbackPostRequestFeedbackInner', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdFeedbackPostRequestFeedbackInner', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdFeedbackPostRequestFeedbackInner
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackPostRequestFeedbackInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackPostRequestFeedbackInner);
    });
