...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsBatchPost200ResponseValueMonitoring();
  });
  ...
  describe('ApiV1StreamsBatchPost200ResponseValueMonitoring', function() {
    it('should create an instance of ApiV1StreamsBatchPost200ResponseValueMonitoring', function() {
      // uncomment below and update the code to test ApiV1StreamsBatchPost200ResponseValueMonitoring
      //var instance = new MatroidPublicApi.ApiV1StreamsBatchPost200ResponseValueMonitoring();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsBatchPost200ResponseValueMonitoring);
    });
