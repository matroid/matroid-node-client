...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInner();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInner', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInner', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInner
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdGet200ResponseInnerPredictionsInner);
    });
