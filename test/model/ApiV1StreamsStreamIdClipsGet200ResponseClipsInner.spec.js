...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdClipsGet200ResponseClipsInner();
  });
  ...
  describe('ApiV1StreamsStreamIdClipsGet200ResponseClipsInner', function() {
    it('should create an instance of ApiV1StreamsStreamIdClipsGet200ResponseClipsInner', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdClipsGet200ResponseClipsInner
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdClipsGet200ResponseClipsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdClipsGet200ResponseClipsInner);
    });
