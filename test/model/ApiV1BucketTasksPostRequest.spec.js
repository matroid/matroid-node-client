...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1BucketTasksPostRequest();
  });
  ...
  describe('ApiV1BucketTasksPostRequest', function() {
    it('should create an instance of ApiV1BucketTasksPostRequest', function() {
      // uncomment below and update the code to test ApiV1BucketTasksPostRequest
      //var instance = new MatroidPublicApi.ApiV1BucketTasksPostRequest();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1BucketTasksPostRequest);
    });
