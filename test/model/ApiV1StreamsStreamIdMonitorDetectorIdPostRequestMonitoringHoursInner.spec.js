...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPostRequestMonitoringHoursInner();
  });
  ...
  describe('ApiV1StreamsStreamIdMonitorDetectorIdPostRequestMonitoringHoursInner', function() {
    it('should create an instance of ApiV1StreamsStreamIdMonitorDetectorIdPostRequestMonitoringHoursInner', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdMonitorDetectorIdPostRequestMonitoringHoursInner
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPostRequestMonitoringHoursInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPostRequestMonitoringHoursInner);
    });
    ...
    it('should have the property startHours (base name: "startHours")', function() {
      // uncomment below and update the code to test the property startHours
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPostRequestMonitoringHoursInner();
      //expect(instance).to.be();
    });

    it('should have the property startMinutes (base name: "startMinutes")', function() {
      // uncomment below and update the code to test the property startMinutes
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPostRequestMonitoringHoursInner();
      //expect(instance).to.be();
    });

    it('should have the property endHours (base name: "endHours")', function() {
      // uncomment below and update the code to test the property endHours
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPostRequestMonitoringHoursInner();
      //expect(instance).to.be();
    });

    it('should have the property endMinutes (base name: "endMinutes")', function() {
      // uncomment below and update the code to test the property endMinutes
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdMonitorDetectorIdPostRequestMonitoringHoursInner();
      //expect(instance).to.be();
    });
