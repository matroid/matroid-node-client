...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1SummariesSummaryIdGet200Response();
  });
  ...
  describe('ApiV1SummariesSummaryIdGet200Response', function() {
    it('should create an instance of ApiV1SummariesSummaryIdGet200Response', function() {
      // uncomment below and update the code to test ApiV1SummariesSummaryIdGet200Response
      //var instance = new MatroidPublicApi.ApiV1SummariesSummaryIdGet200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1SummariesSummaryIdGet200Response);
    });
    ...
    it('should have the property mcLambda (base name: "mcLambda")', function() {
      // uncomment below and update the code to test the property mcLambda
      //var instance = new MatroidPublicApi.ApiV1SummariesSummaryIdGet200Response();
      //expect(instance).to.be();
    });

    it('should have the property matchingDistance (base name: "matchingDistance")', function() {
      // uncomment below and update the code to test the property matchingDistance
      //var instance = new MatroidPublicApi.ApiV1SummariesSummaryIdGet200Response();
      //expect(instance).to.be();
    });

    it('should have the property maxIouDist (base name: "maxIouDist")', function() {
      // uncomment below and update the code to test the property maxIouDist
      //var instance = new MatroidPublicApi.ApiV1SummariesSummaryIdGet200Response();
      //expect(instance).to.be();
    });
    ...
    it('should have the property nInit (base name: "nInit")', function() {
      // uncomment below and update the code to test the property nInit
      //var instance = new MatroidPublicApi.ApiV1SummariesSummaryIdGet200Response();
      //expect(instance).to.be();
    });

    it('should have the property nnBudget (base name: "nnBudget")', function() {
      // uncomment below and update the code to test the property nnBudget
      //var instance = new MatroidPublicApi.ApiV1SummariesSummaryIdGet200Response();
      //expect(instance).to.be();
    });

    it('should have the property detectionThreshold (base name: "detectionThreshold")', function() {
      // uncomment below and update the code to test the property detectionThreshold
      //var instance = new MatroidPublicApi.ApiV1SummariesSummaryIdGet200Response();
      //expect(instance).to.be();
    });
