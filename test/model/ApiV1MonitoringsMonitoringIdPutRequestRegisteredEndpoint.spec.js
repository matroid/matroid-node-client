...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequestRegisteredEndpoint);
    });
