...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdPutRequest();
  });
  ...
  describe('ApiV1StreamsStreamIdPutRequest', function() {
    it('should create an instance of ApiV1StreamsStreamIdPutRequest', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdPutRequest
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdPutRequest();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdPutRequest);
    });
