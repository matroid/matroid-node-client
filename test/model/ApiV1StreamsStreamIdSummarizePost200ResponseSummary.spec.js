...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdSummarizePost200ResponseSummary();
  });
  ...
  describe('ApiV1StreamsStreamIdSummarizePost200ResponseSummary', function() {
    it('should create an instance of ApiV1StreamsStreamIdSummarizePost200ResponseSummary', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdSummarizePost200ResponseSummary
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdSummarizePost200ResponseSummary();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdSummarizePost200ResponseSummary);
    });
