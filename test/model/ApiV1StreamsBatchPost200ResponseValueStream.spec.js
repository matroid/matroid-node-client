...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsBatchPost200ResponseValueStream();
  });
  ...
  describe('ApiV1StreamsBatchPost200ResponseValueStream', function() {
    it('should create an instance of ApiV1StreamsBatchPost200ResponseValueStream', function() {
      // uncomment below and update the code to test ApiV1StreamsBatchPost200ResponseValueStream
      //var instance = new MatroidPublicApi.ApiV1StreamsBatchPost200ResponseValueStream();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsBatchPost200ResponseValueStream);
    });
