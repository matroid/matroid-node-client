...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequestColors();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdPutRequestColors', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdPutRequestColors', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdPutRequestColors
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequestColors();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdPutRequestColors);
    });
