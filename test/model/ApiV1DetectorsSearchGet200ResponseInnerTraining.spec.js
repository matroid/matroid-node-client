...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsSearchGet200ResponseInnerTraining();
  });
  ...
  describe('ApiV1DetectorsSearchGet200ResponseInnerTraining', function() {
    it('should create an instance of ApiV1DetectorsSearchGet200ResponseInnerTraining', function() {
      // uncomment below and update the code to test ApiV1DetectorsSearchGet200ResponseInnerTraining
      //var instance = new MatroidPublicApi.ApiV1DetectorsSearchGet200ResponseInnerTraining();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsSearchGet200ResponseInnerTraining);
    });
