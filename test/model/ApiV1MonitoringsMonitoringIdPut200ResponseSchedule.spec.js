...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPut200ResponseSchedule();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdPut200ResponseSchedule', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdPut200ResponseSchedule', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdPut200ResponseSchedule
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPut200ResponseSchedule();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdPut200ResponseSchedule);
    });
