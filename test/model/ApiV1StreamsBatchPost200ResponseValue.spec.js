...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsBatchPost200ResponseValue();
  });
  ...
  describe('ApiV1StreamsBatchPost200ResponseValue', function() {
    it('should create an instance of ApiV1StreamsBatchPost200ResponseValue', function() {
      // uncomment below and update the code to test ApiV1StreamsBatchPost200ResponseValue
      //var instance = new MatroidPublicApi.ApiV1StreamsBatchPost200ResponseValue();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsBatchPost200ResponseValue);
    });
