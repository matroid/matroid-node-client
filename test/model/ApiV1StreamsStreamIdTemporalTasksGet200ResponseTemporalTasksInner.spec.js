...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsStreamIdTemporalTasksGet200ResponseTemporalTasksInner();
  });
  ...
  describe('ApiV1StreamsStreamIdTemporalTasksGet200ResponseTemporalTasksInner', function() {
    it('should create an instance of ApiV1StreamsStreamIdTemporalTasksGet200ResponseTemporalTasksInner', function() {
      // uncomment below and update the code to test ApiV1StreamsStreamIdTemporalTasksGet200ResponseTemporalTasksInner
      //var instance = new MatroidPublicApi.ApiV1StreamsStreamIdTemporalTasksGet200ResponseTemporalTasksInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsStreamIdTemporalTasksGet200ResponseTemporalTasksInner);
    });
