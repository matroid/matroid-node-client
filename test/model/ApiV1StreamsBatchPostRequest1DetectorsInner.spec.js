...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1StreamsBatchPostRequest1DetectorsInner();
  });
  ...
  describe('ApiV1StreamsBatchPostRequest1DetectorsInner', function() {
    it('should create an instance of ApiV1StreamsBatchPostRequest1DetectorsInner', function() {
      // uncomment below and update the code to test ApiV1StreamsBatchPostRequest1DetectorsInner
      //var instance = new MatroidPublicApi.ApiV1StreamsBatchPostRequest1DetectorsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1StreamsBatchPostRequest1DetectorsInner);
    });
