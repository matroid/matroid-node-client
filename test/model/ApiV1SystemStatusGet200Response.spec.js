...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1SystemStatusGet200Response();
  });
  ...
  describe('ApiV1SystemStatusGet200Response', function() {
    it('should create an instance of ApiV1SystemStatusGet200Response', function() {
      // uncomment below and update the code to test ApiV1SystemStatusGet200Response
      //var instance = new MatroidPublicApi.ApiV1SystemStatusGet200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1SystemStatusGet200Response);
    });

    it('should have the property licenseIsActive (base name: "licenseIsActive")', function() {
      // uncomment below and update the code to test the property licenseIsActive
      //var instance = new MatroidPublicApi.ApiV1SystemStatusGet200Response();
    ...
    it('should have the property mostRecentDetectionTimestamp (base name: "mostRecentDetectionTimestamp")', function() {
      // uncomment below and update the code to test the property mostRecentDetectionTimestamp
      //var instance = new MatroidPublicApi.ApiV1SystemStatusGet200Response();
      //expect(instance).to.be();
    });

    it('should have the property runningMonitorings (base name: "runningMonitorings")', function() {
      // uncomment below and update the code to test the property runningMonitorings
      //var instance = new MatroidPublicApi.ApiV1SystemStatusGet200Response();
      //expect(instance).to.be();
    });

    it('should have the property totalMonitorings (base name: "totalMonitorings")', function() {
      // uncomment below and update the code to test the property totalMonitorings
      //var instance = new MatroidPublicApi.ApiV1SystemStatusGet200Response();
      //expect(instance).to.be();
    });

    it('should have the property adequateCompute (base name: "adequateCompute")', function() {
      // uncomment below and update the code to test the property adequateCompute
      //var instance = new MatroidPublicApi.ApiV1SystemStatusGet200Response();
      //expect(instance).to.be();
    });

    it('should have the property downMonitorings (base name: "downMonitorings")', function() {
      // uncomment below and update the code to test the property downMonitorings
      //var instance = new MatroidPublicApi.ApiV1SystemStatusGet200Response();
      //expect(instance).to.be();
    });
