...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsBatchPutRequestTaskUpdate();
  });
  ...
  describe('ApiV1MonitoringsBatchPutRequestTaskUpdate', function() {
    it('should create an instance of ApiV1MonitoringsBatchPutRequestTaskUpdate', function() {
      // uncomment below and update the code to test ApiV1MonitoringsBatchPutRequestTaskUpdate
      //var instance = new MatroidPublicApi.ApiV1MonitoringsBatchPutRequestTaskUpdate();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsBatchPutRequestTaskUpdate);
    });
