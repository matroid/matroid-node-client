...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsBatchPutRequestTaskUpdateRegisteredEndpoint();
  });
  ...
  describe('ApiV1MonitoringsBatchPutRequestTaskUpdateRegisteredEndpoint', function() {
    it('should create an instance of ApiV1MonitoringsBatchPutRequestTaskUpdateRegisteredEndpoint', function() {
      // uncomment below and update the code to test ApiV1MonitoringsBatchPutRequestTaskUpdateRegisteredEndpoint
      //var instance = new MatroidPublicApi.ApiV1MonitoringsBatchPutRequestTaskUpdateRegisteredEndpoint();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsBatchPutRequestTaskUpdateRegisteredEndpoint);
    });
