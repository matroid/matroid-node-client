...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPut200ResponseRegion();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdPut200ResponseRegion', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdPut200ResponseRegion', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdPut200ResponseRegion
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPut200ResponseRegion();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdPut200ResponseRegion);
    });
    ...
    it('should have the property focusAreas (base name: "focusAreas")', function() {
      // uncomment below and update the code to test the property focusAreas
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdPut200ResponseRegion();
      //expect(instance).to.be();
    });
