...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdImageQueryPost200ResponseResultsInner();
  });
  ...
  describe('ApiV1CollectionTasksTaskIdImageQueryPost200ResponseResultsInner', function() {
    it('should create an instance of ApiV1CollectionTasksTaskIdImageQueryPost200ResponseResultsInner', function() {
      // uncomment below and update the code to test ApiV1CollectionTasksTaskIdImageQueryPost200ResponseResultsInner
      //var instance = new MatroidPublicApi.ApiV1CollectionTasksTaskIdImageQueryPost200ResponseResultsInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1CollectionTasksTaskIdImageQueryPost200ResponseResultsInner);
    });
