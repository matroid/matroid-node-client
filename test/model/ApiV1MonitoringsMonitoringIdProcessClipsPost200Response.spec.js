...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdProcessClipsPost200Response();
  });
  ...
  describe('ApiV1MonitoringsMonitoringIdProcessClipsPost200Response', function() {
    it('should create an instance of ApiV1MonitoringsMonitoringIdProcessClipsPost200Response', function() {
      // uncomment below and update the code to test ApiV1MonitoringsMonitoringIdProcessClipsPost200Response
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdProcessClipsPost200Response();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1MonitoringsMonitoringIdProcessClipsPost200Response);
    });

    it('should have the property temporalTask (base name: "temporal_task")', function() {
      // uncomment below and update the code to test the property temporalTask
      //var instance = new MatroidPublicApi.ApiV1MonitoringsMonitoringIdProcessClipsPost200Response();
