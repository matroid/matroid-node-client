...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInner();
  });
  ...
  describe('ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInner', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInner', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInner
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdLabelsLabelIdGet200ResponseImagesInner);
    });
