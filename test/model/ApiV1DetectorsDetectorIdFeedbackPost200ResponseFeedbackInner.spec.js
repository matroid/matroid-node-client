...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInner();
  });
  ...
  describe('ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInner', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInner', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInner
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInner();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdFeedbackPost200ResponseFeedbackInner);
    });
