...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdGet200ResponseTraining();
  });
  ...
  describe('ApiV1DetectorsDetectorIdGet200ResponseTraining', function() {
    it('should create an instance of ApiV1DetectorsDetectorIdGet200ResponseTraining', function() {
      // uncomment below and update the code to test ApiV1DetectorsDetectorIdGet200ResponseTraining
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdGet200ResponseTraining();
      //expect(instance).to.be.a(MatroidPublicApi.ApiV1DetectorsDetectorIdGet200ResponseTraining);
    });
    ...
    it('should have the property totalImages (base name: "totalImages")', function() {
    ...
    it('should have the property trainingRequestedAt (base name: "trainingRequestedAt")', function() {
      // uncomment below and update the code to test the property trainingRequestedAt
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdGet200ResponseTraining();
      //expect(instance).to.be();
    });

    it('should have the property estimatedStartTime (base name: "estimatedStartTime")', function() {
      // uncomment below and update the code to test the property estimatedStartTime
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdGet200ResponseTraining();
      //expect(instance).to.be();
    });
    ...
    it('should have the property trainingFinishedAt (base name: "trainingFinishedAt")', function() {
      // uncomment below and update the code to test the property trainingFinishedAt
      //var instance = new MatroidPublicApi.ApiV1DetectorsDetectorIdGet200ResponseTraining();
      //expect(instance).to.be();
    });
